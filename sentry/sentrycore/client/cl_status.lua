...
Citizen.CreateThread(function()
	while true do
		...
		SetDiscordRichPresenceAssetText("discord.gg/SentryGTA") 
		SetDiscordRichPresenceAssetSmall('6f8144df-fd1f-4068-a450-4eb1d4b442dc') -- Name of the smaller image asset.
		SetDiscordRichPresenceAssetSmallText('Sentry')
		SetRichPresence("" ..#GetActivePlayers().. "/" .. "64" .. " Players") 
		SetDiscordRichPresenceAction(0, 'Discord', 'discord.gg/SentryGTA')
