...
RageUI.CreateWhile(1.0, true, function()
    if RageUI.Visible(RMenu:Get("LicenseCentre", "confirm")) then
        ...
        if cGroup == 'Diamond' then 
            RageUI.Separator("~g~Diamond Price: £5,000,000", function() end)
            RageUI.Separator("~g~Per Peice: £10,000", function() end)
            RageUI.Separator("~g~One 200KG Run: £500,000", function() end)
            RageUI.Separator("~g~One 300KG Run: £750,000", function() end)
        elseif cGroup == 'Gold' then 
            RageUI.Separator("~g~Gold Price: £1,000,000", function() end)
            RageUI.Separator("~g~Per Peice: £2,500", function() end)
            RageUI.Separator("~g~One 200KG Run: £125,000", function() end)
            RageUI.Separator("~g~One 300KG Run: £187,500", function() end)
        elseif cGroup == 'Scrap' then 
            RageUI.Separator("~g~Scrap Price: £100,000", function() end)
            RageUI.Separator("~g~Per Peice: £250", function() end)
            RageUI.Separator("~g~One 200KG Run: £12,500", function() end)
            RageUI.Separator("~g~One 300KG Run: £18,750", function() end)
        end
