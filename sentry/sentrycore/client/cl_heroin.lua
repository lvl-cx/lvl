          ...
          while InRangeGather do
            ...
            if IsControlJustReleased(0, 51)  then
              if not pedinveh then
                ...
                TriggerServerEvent('Sentry:GatherHeroin')
                
                exports.rprogress:Start("", 5000)
                ClearPedTasksImmediately(ped)
                Action = false
              else
                Sentry.notify({"~r~You cant gather Heroin while Driving!"})
              end
            end
          end
        end)
        ...
        Citizen.CreateThread(function()
          while InRangeProcess do
            ...
            if IsControlJustReleased(0, 51)  then
              ...
              TriggerServerEvent('Sentry:ProcessHeroin')
...
-- [RageUI Menu]
RMenu.Add('HeroinMenu', 'Heroin Seller', RageUI.CreateMenu("", "~g~Sentry Heroin Seller",1300, 50, "heroin", "heroin"))
  ...
  if RageUI.Visible(RMenu:Get('HeroinMenu', 'Heroin Seller')) then
    ...
    RageUI.Button("Sell Heroin" , nil, {}, true, function(Hovered, Active, Selected)
        if Selected then
            ...
            TriggerServerEvent('Sentry:SellHeroin')
        end
    end)
