RMenu.Add('SentryClothing', 'main', RageUI.CreateMenu("", "~g~Sentry Clothing Menu",1300, 50, 'cstore', 'cstore'))
RMenu.Add('SentryClothing', 'clothingsubmenu',  RageUI.CreateSubMenu(RMenu:Get("SentryClothing", "main")))
RMenu.Add('SentryClothing', 'changegendersubmenu',  RageUI.CreateSubMenu(RMenu:Get("SentryClothing", "main")))
RMenu.Add('SentryClothing', 'changepedmenu',  RageUI.CreateSubMenu(RMenu:Get("SentryClothing", "main")))
...
RageUI.CreateWhile(1.0, true, function()
    ...
    if RageUI.Visible(RMenu:Get('SentryClothing', 'main')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
           RageUI.Button("Change Clothing", nil, {RightLabel = '~g~→'}, true, function(Hovered, Active, Selected) end, RMenu:Get("SentryClothing", "clothingsubmenu"))
           RageUI.Button("Change Gender", nil, {RightLabel = '~g~→'}, true, function(Hovered, Active, Selected) end, RMenu:Get("SentryClothing", "changegendersubmenu"))
           RageUI.Button("Change Ped", nil, {RightLabel = '~g~→'}, true, function(Hovered, Active, Selected) end, RMenu:Get("SentryClothing", "changepedmenu"))
        end)
    end
    if RageUI.Visible(RMenu:Get('SentryClothing', 'changegendersubmenu')) then 
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            ...
            end,RMenu:Get("SentryClothing", "changegendersubmenu"))
    ...
    if RageUI.Visible(RMenu:Get('SentryClothing', 'changepedmenu')) then 
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
    ...
    if RageUI.Visible(RMenu:Get('SentryClothing', 'clothingsubmenu')) then
...
Citizen.CreateThread(function()
    while true do 
        ...
        if not inMarker and MenuOpen then
            ...
            PlaySound(-1,"Hit","RESPAWN_SOUNDSET",0,0,1)
            RageUI.Visible(RMenu:Get('SentryClothing', 'clothingsubmenu'), false)
            RageUI.Visible(RMenu:Get('SentryClothing', 'changegendersubmenu'), false)  
            RageUI.Visible(RMenu:Get('SentryClothing', 'main'), false)
            MenuOpen = false
        end
    end
end)
