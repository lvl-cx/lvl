...
RMenu.Add('adminmenu', 'main', RageUI.CreateMenu("", "~g~Sentry Admin Menu", 1300, 50, 'admin', 'admin'))
...
RMenu.Add("adminmenu", "settings", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "main"),"","~g~Sentry Admin Menu", 1300, 50,"admin","admin"))
...
RegisterNetEvent('Sentry:ReturnPOV')
AddEventHandler('Sentry:ReturnPOV', function(pov)
    povlist = pov
end)
        ...
        for k,v in pairs(players) do
            RageUI.Button("[" .. v[3] .. "] " .. v[1], nil, {RightLabel = "~g~→"}, true, function(Hovered, Active, Selected)
                if Selected then
                    ...
                    SelectedPerm = v[3]
                    TriggerServerEvent("Sentry:CheckPOV",v[3])
                end
...
RMenu.Add('SettingsMenu', 'MainMenu', RageUI.CreateMenu("", "~g~Sentry Settings Menu", 1300, 50,"settings","settings")) 
            ...
            RageUI.Checkbox("Rust Hitsounds",nil, HitmarkerSounds, {Style = RageUI.CheckboxStyle.Car}, function(Hovered, Active, Selected, Checked)
                if Selected then 
                    if not HitmarkerSounds then
                        TriggerEvent("Sentry:Settings:Hitsounds", true)
                        HitmarkerSounds = true
                    else
                        TriggerEvent("Sentry:Settings:Hitsounds", false)
...
RegisterNetEvent('Sentry:OpenSettingsMenu')
AddEventHandler('Sentry:OpenSettingsMenu', function(admin)
    if not admin then
...
RegisterCommand('opensettingsmenu',function()
    TriggerServerEvent('Sentry:OpenSettings')
end)
                ...
                RageUI.Button("Remove Warning", nil, {RightLabel = "~g~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        ...
                        if (GetOnscreenKeyboardResult()) then
                            ...
                            if result then 
                                TriggerServerEvent('Sentry:RemoveWarning', uid, result)
                            end
                        end
                    end
                end, RMenu:Get('adminmenu', 'generalfunctions'))
            ...
            if admincfg.buttonsEnabled["ban"][1] and buttons["ban"] then
                RageUI.Button("Unban Player",nil,{RightLabel = "~g~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        ...
                        TriggerServerEvent("Sentry:Unban", permid)
                    end
                end)
            end
            ...
            if admincfg.buttonsEnabled["ban"][1] and buttons["ban"] then
                RageUI.Button("Offline Ban",nil,{RightLabel = "~g~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        ...
                        TriggerServerEvent('Sentry:BanPlayer', uid, permid, banReason, tonumber(banTime))
                    end
                end)
            end
        end)
        ...
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            ...
            if admincfg.buttonsEnabled["devMenu"][1] and buttons["devMenu"] then
                RageUI.Button("Entity Cleanup", nil, {RightLabel = "~g~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent('Sentry:PropCleanup')
                    end
                end, RMenu:Get('adminmenu', 'entityfunctions'))
            end
            ...
            if admincfg.buttonsEnabled["devMenu"][1] and buttons["devMenu"] then
                RageUI.Button("Deattach Entity Cleanup", nil, {RightLabel = "~g~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent('Sentry:DeAttachEntity')
                    end
                end, RMenu:Get('adminmenu', 'entityfunctions'))
            end
            ...
            if admincfg.buttonsEnabled["devMenu"][1] and buttons["devMenu"] then
                RageUI.Button("Vehicle Cleanup", nil, {RightLabel = "~g~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent('Sentry:VehCleanup')
                    end
                end, RMenu:Get('adminmenu', 'entityfunctions'))
            end
            ...
            if admincfg.buttonsEnabled["devMenu"][1] and buttons["devMenu"] then
                RageUI.Button("Ped Cleanup", nil, {RightLabel = "~g~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent('Sentry:PedCleanup')
                    end
                end, RMenu:Get('adminmenu', 'entityfunctions'))
            end
            ...
            if admincfg.buttonsEnabled["devMenu"][1] and buttons["devMenu"] then
                RageUI.Button("All Cleanup", nil, {RightLabel = "~g~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent('Sentry:CleanAll')
                    end
                end, RMenu:Get('adminmenu', 'entityfunctions'))
            end
                ...
                RageUI.Button("Fix Vehicle", nil, {RightLabel = "~g~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        ...
                        if IsPedInAnyVehicle(playerPed, false) then
                            ...
                            tSentry.notify("~g~Your vehicle has been fixed!")
                        else
                            tSentry.notify("~o~You're not in a vehicle! There is no vehicle to fix!")
                        end
                    end
                end, RMenu:Get('adminmenu', 'vehiclefunctions'))
            end
                ...
                RageUI.Button("Clean Vehicle", nil, {RightLabel = "~g~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        ...
                        if IsPedInAnyVehicle(playerPed, false) then
                            ...
                            tSentry.notify("~b~Your vehicle has been cleaned!")
                        else
                            tSentry.notify("~o~You're not in a vehicle! There is no vehicle to clean!")
                        end
                    end
                end, RMenu:Get('adminmenu', 'vehiclefunctions'))
            end
        ...
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
                ...
                RageUI.Button("Spawn Weapon", nil, {RightLabel = "~g~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        ...
                        if (GetOnscreenKeyboardResult()) then
                            local result = GetOnscreenKeyboardResult()
                            if result then 
                              --  Sentryclient.allowWeapon(result, "-1")
                                Wait(500)
            ...
            if admincfg.buttonsEnabled["devMenu"][1] and buttons["devMenu"] then
                RageUI.Button("Teleport to Coords",nil,{RightLabel = "~g~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent("Sentry:Tp2Coords")
                    end
                end, RMenu:Get('adminmenu', 'devfunctions'))
            end
                ...
                RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
                    ...
                    if admincfg.buttonsEnabled["FREEZE"][1] and buttons["FREEZE"] then
                        RageUI.Button("Freeze Player", nil, {RightLabel = "~g~→"}, true, function(Hovered, Active, Selected)
                            if Selected then
                                ...
                                TriggerServerEvent('Sentry:FreezeSV', uid, SelectedPlayer[2], isFrozen)
                            end
                        end)
                    end
                    ...
                    if admincfg.buttonsEnabled["slap"][1] and buttons["slap"] then
                        RageUI.Button("Slap Player", nil, {RightLabel = "~g~→"}, true, function(Hovered, Active, Selected)
                            if Selected then
                                local uid = GetPlayerServerId(PlayerId())
                                TriggerServerEvent('Sentry:SlapPlayer', uid, SelectedPlayer[2])
                            end
                        end)
                    end
                    ...
                    if admincfg.buttonsEnabled["revive"][1] and buttons["revive"] then
                        RageUI.Button("Revive Player", nil, {RightLabel = "~g~→"}, true, function(Hovered, Active, Selected)
                            if Selected then
                                local uid = GetPlayerServerId(PlayerId())
                                TriggerServerEvent('Sentry:RevivePlayer', uid, SelectedPlayer[2])
                            end
                        end)
                    end
                    ...
                    if admincfg.buttonsEnabled["spectate"][1] and buttons["spectate"] then
                        RageUI.Button("Spectate Player", nil, {RightLabel = "~g~→"}, true, function(Hovered, Active, Selected)
                            if Selected then
                                ...
                                TriggerServerEvent('SentryAdmin:SpectatePlr', SelectedPlayer[3])
                            end
                        end)
                    end
                ...
                RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
                        ...
                        RageUI.Button("Add Import Car", nil, {RightLabel = "~g~→"}, true, function(Hovered, Active, Selected)
                            if Selected then
                                ...
                                if (GetOnscreenKeyboardResult()) then
                                    local result = GetOnscreenKeyboardResult()
                                    if result then 
                                        TriggerServerEvent('Sentry:AddCar', SelectedPlayer[3], result)
                                    end
                                end
                            end
                        end, RMenu:Get('adminmenu', 'submenu'))
                    ...
                    if admincfg.buttonsEnabled["getgroups"][1] and buttons["getgroups"] then
                        RageUI.Button("Get Groups",nil,{RightLabel = "~g~→"}, true, function(Hovered, Active, Selected)
                            if Selected then
                                TriggerServerEvent("Sentry:getGroups", SelectedPlayer[2], SelectedPlayer[3])
                            end
                    ...
                    if admincfg.buttonsEnabled["kick"][1] and buttons["kick"] then
                        RageUI.Button("Kick Player", nil, {RightLabel = "~g~→"}, true, function(Hovered, Active, Selected)
                            if Selected then
                                ...
                                local uid = GetPlayerServerId(PlayerId())
                                TriggerServerEvent('Sentry:KickPlayer', uid, SelectedPlayer[3], kickReason, SelectedPlayer[2])
                            end
                        end)
                    end
                    ...
                    if admincfg.buttonsEnabled["nof10kick"][1] and buttons["nof10kick"] then
                        RageUI.Button("No F10 Kick", nil, {RightLabel = "~g~→"}, true, function(Hovered, Active, Selected)
                            if Selected then
                                local kickReason = KeyboardInput("Reason:", "", 100)
                                local uid = GetPlayerServerId(PlayerId())
                                TriggerServerEvent('Sentry:KickPlayerNoF10', uid, SelectedPlayer[3], kickReason)
                            end
                        end)
                    end
                ...
                for i , p in pairs(warningbankick) do 
                    RageUI.Button("Warn Player for "..p.name, nil, { RightLabel = "~g~→" }, true, function(Hovered, Active, Selected)
                        if Selected then
                            ...
                            TriggerServerEvent("sentry:warnPlayer",SelectedPlayer[3],p.name)
                ...
                RageUI.Button("[Custom Ban Message]", nil, {RightLabel = "~g~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        ...
                        if reason2 then 
                            ...
                            TriggerServerEvent('Sentry:BanPlayer', uid, SelectedPlayer[3], reason2, timeForBan)
                        end
                ...
                for i , p in pairs(warningbankick) do 
                    RageUI.Button("Ban Player for "..p.name, nil, { RightLabel = ">>>" }, true, function(Hovered, Active, Selected)
                        if Selected then
                            local uid = GetPlayerServerId(PlayerId())
                            local banTime = KeyboardInput("Hours:", "", 20)
                            TriggerServerEvent('Sentry:BanPlayer', uid, SelectedPlayer[3], p.name, tonumber(banTime))
                        end
                    end, RMenu:Get('adminmenu', 'submenu'))
                 end
        ...
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            if admincfg.buttonsEnabled["TP2"][1] and buttons["TP2"] then
                RageUI.Button("Teleport to Player", nil, {RightLabel = "~g~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        ...
                        TriggerServerEvent('Sentry:TeleportToPlayer', newSource, SelectedPlayer[2])
            ...
            if admincfg.buttonsEnabled["TPLoc"][1] and buttons["TPLoc"] then
                RageUI.Button("Teleport Player To Me", nil, {RightLabel = "~g~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent('SentryAdmin:Bring', SelectedPlayer[3])
            ...
            if admincfg.buttonsEnabled["TP2ME"][1] and buttons["TP2ME"] then
                RageUI.Button("Teleport Player To Admin Island", nil, {RightLabel = "~g~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent("Sentry:Teleport2AdminIsland", SelectedPlayer[2])
            ...
            if admincfg.buttonsEnabled["TP2ME"][1] and buttons["TP2ME"] then
                RageUI.Button("Return Player to Previous Location", nil, {RightLabel = "~g~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent("Sentry:returnplayer", SelectedPlayer[2])
                ...
                if admincfg.buttonsEnabled["TPLoc"][1] and buttons["TPLoc"] then -- TPLoc
                    RageUI.Button("Teleport Player Legion Bank", nil, {RightLabel = "~g~→"}, true, function(Hovered, Active, Selected)
                        if Selected then
                            TriggerServerEvent("Sentry:Teleport", SelectedPlayer[2], vector3(151.61740112305,-1035.05078125,29.339416503906))
                ...
                if admincfg.buttonsEnabled["TPLoc"][1] and buttons["TPLoc"] then
                    RageUI.Button("Teleport Player To City License Centre", nil, {RightLabel = "~g~→"}, true, function(Hovered, Active, Selected)
                        if Selected then
                            TriggerServerEvent("Sentry:Teleport", SelectedPlayer[2], vector3(-537.10968017578,-217.92503356934,37.64965057373 ))
                            notify('~g~Teleported player to location.')
                        end
                    end, RMenu:Get('adminmenu', 'teleportmenu'))
                end
                ...
                if admincfg.buttonsEnabled["TPLoc"][1] and buttons["TPLoc"] then
                    RageUI.Button("Teleport Player To Sandy License Centre", nil, {RightLabel = "~g~→"}, true, function(Hovered, Active, Selected)
                        if Selected then
                            TriggerServerEvent("Sentry:Teleport", SelectedPlayer[2], vector3(1707.1434326172,3775.55078125,34.537727355957))
                            notify('~g~Teleported player to location.')
                        end
                    end, RMenu:Get('adminmenu', 'teleportmenu'))
                end
                ...
                if admincfg.buttonsEnabled["TPLoc"][1] and buttons["TPLoc"] then
                    RageUI.Button("Teleport Player Rebel Diner", nil, {RightLabel = "~g~→"}, true, function(Hovered, Active, Selected)
                        if Selected then
                            TriggerServerEvent("Sentry:Teleport", SelectedPlayer[2], vector3(1581.6401367188,6445.6494140625,24.999206542969))
                            notify('~g~Teleported player to location.')
                        end
                    end, RMenu:Get('adminmenu', 'teleportmenu'))
                end
        ...
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            ...
            RageUI.Button("Add this group to user", nil, { RightLabel = "~g~→" }, true, function(Hovered, Active, Selected)
                if (Selected) then
                    ...
                    TriggerServerEvent("Sentry:addGroup",SelectedPerm,selectedGroup)
                end
            end, RMenu:Get('adminmenu', 'groups'))
    ...
    if RageUI.Visible(RMenu:Get('adminmenu', 'removegroup')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            ...
            RageUI.Button("Remove user from group", "", { RightLabel = "~g~→" }, true, function(Hovered, Active, Selected)
                if (Selected) then
                    TriggerServerEvent("Sentry:removeGroup",SelectedPerm,selectedGroup)
                end
            end, RMenu:Get('adminmenu', 'groups'))
...
RegisterNetEvent('Sentry:SlapPlayer')
AddEventHandler('Sentry:SlapPlayer', function()
    SetEntityHealth(PlayerPedId(), 0)
end)

FrozenPlayer = false

RegisterNetEvent('Sentry:Freeze')
AddEventHandler('Sentry:Freeze', function(isForzen)
...
RegisterNetEvent('Sentry:Teleport')
AddEventHandler('Sentry:Teleport', function(coords)
    print(coords)
    SetEntityCoords(PlayerPedId(), coords)
end)

RegisterNetEvent('Sentry:Teleport2Me2')
AddEventHandler('Sentry:Teleport2Me2', function(target2)
    local coords = GetEntityCoords(GetPlayerPed(GetPlayerFromServerId(target2)))
    SetEntityCoords(PlayerPedId(), coords)
end)


RegisterNetEvent("Sentry:SendPlayersInfo")
AddEventHandler("Sentry:SendPlayersInfo",function(players_table, btns)
...
RegisterNetEvent('Sentry:SpectateClient')
AddEventHandler('Sentry:SpectateClient', function(target)
...
RegisterNetEvent("Sentry:gotgroups")
AddEventHandler("Sentry:gotgroups",function(gotGroups)
...
RegisterNetEvent('Sentry:Notify')
AddEventHandler('Sentry:Notify', function(string)
    notify('~g~' .. string)
end)

RegisterCommand('openadminmenu',function()
    TriggerServerEvent("Sentry:GetPlayerData")
end)
...
RegisterNetEvent("Sentry:TPCoords")
AddEventHandler("Sentry:TPCoords", function(coords)
...
RegisterNetEvent("Sentry:EntityWipe")
AddEventHandler("Sentry:EntityWipe", function(id)
    Citizen.CreateThread(function() 
...
RegisterNetEvent('SentryAdmin:Spectate')
AddEventHandler('SentryAdmin:Spectate', function(plr,tpcoords)
    local playerPed = PlayerPedId()
    ...
    if not Spectating then
        ...
        if targetPed == playerPed then tSentry.notify('~r~I mean you cannot spectate yourself...') return end
        ...
        tSentry.notify('~r~Stopped Spectating Player.')
    end 
end)