RegisterNetEvent("OASIS:announceRestart")
AddEventHandler("OASIS:announceRestart",function(a,b)
...
RegisterNetEvent("OASIS:smallAnnouncement",function(f,g,h,i)
    tOASIS.announceMpSmallMsg(f,g,h,i)
end)
function tOASIS.announceMpSmallMsg(f,g,h,i)
