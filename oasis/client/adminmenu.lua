...
RMenu.Add('adminmenu', 'main', RageUI.CreateMenu("", "~b~Admin Menu", tOASIS.getRageUIMenuWidth(), tOASIS.getRageUIMenuHeight(), "banners", "admin"))
RMenu.Add("adminmenu", "players", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "main"), "", menuColour..'Admin Player Interaction Menu',tOASIS.getRageUIMenuWidth(), tOASIS.getRageUIMenuHeight(),"banners","admin"))
RMenu.Add("adminmenu", "closeplayers", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "main"), "", menuColour..'Admin Player Interaction Menu',tOASIS.getRageUIMenuWidth(), tOASIS.getRageUIMenuHeight(),"banners","admin"))
RMenu.Add("adminmenu", "searchoptions", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "main"), "", menuColour..'Admin Player Search Menu',tOASIS.getRageUIMenuWidth(), tOASIS.getRageUIMenuHeight(),"banners","admin"))
RMenu.Add("adminmenu", "functions", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "main"), "", menuColour..'Admin Functions Menu',tOASIS.getRageUIMenuWidth(), tOASIS.getRageUIMenuHeight(),"banners","admin"))
RMenu.Add("adminmenu", "devfunctions", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "main"), "", menuColour..'Dev Functions Menu',tOASIS.getRageUIMenuWidth(), tOASIS.getRageUIMenuHeight(),"banners","admin"))
RMenu.Add("adminmenu", "communitypot", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "functions"), "", menuColour..'Community Pot',tOASIS.getRageUIMenuWidth(), tOASIS.getRageUIMenuHeight(),"banners", "communitypot"))
RMenu.Add("adminmenu", "moneymenu", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "functions"), "", menuColour..'Money Menu',tOASIS.getRageUIMenuWidth(), tOASIS.getRageUIMenuHeight(),"banners", "admin"))
RMenu.Add("adminmenu", "submenu", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "players"), "", menuColour..'Admin Player Interaction Menu',tOASIS.getRageUIMenuWidth(), tOASIS.getRageUIMenuHeight(),"banners", "admin"))
RMenu.Add("adminmenu", "searchname", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "searchoptions"), "", menuColour..'Admin Player Search Menu',tOASIS.getRageUIMenuWidth(), tOASIS.getRageUIMenuHeight(),"banners", "admin"))
RMenu.Add("adminmenu", "searchtempid", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "searchoptions"), "", menuColour..'Admin Player Search Menu',tOASIS.getRageUIMenuWidth(), tOASIS.getRageUIMenuHeight(),"banners", "admin"))
RMenu.Add("adminmenu", "searchpermid", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "searchoptions"), "", menuColour..'Admin Player Search Menu',tOASIS.getRageUIMenuWidth(), tOASIS.getRageUIMenuHeight(),"banners", "admin"))
RMenu.Add("adminmenu", "searchhistory", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "searchoptions"), "", menuColour..'Admin Player Search Menu',tOASIS.getRageUIMenuWidth(), tOASIS.getRageUIMenuHeight(),"banners", "admin"))
RMenu.Add("adminmenu", "notespreviewban", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "players"), "", menuColour..'Player Notes',tOASIS.getRageUIMenuWidth(), tOASIS.getRageUIMenuHeight(),"banners", "admin"))
RMenu.Add("adminmenu", "banselection", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "notespreviewban"), "", menuColour..'Ban Menu ~w~- ~o~[Tab] to search bans',tOASIS.getRageUIMenuWidth(), tOASIS.getRageUIMenuHeight(),"banners", "admin"))
RMenu.Add("adminmenu", "generatedban", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "banselection"), "", menuColour..'Ban Menu',tOASIS.getRageUIMenuWidth(), tOASIS.getRageUIMenuHeight(),"banners", "admin"))
RMenu.Add("adminmenu", "notesub", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "players"), "", menuColour..'Player Notes',tOASIS.getRageUIMenuWidth(), tOASIS.getRageUIMenuHeight(),"banners", "admin"))
RMenu.Add("adminmenu", "groups", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "submenu"), "", menuColour..'Admin Groups Menu ~w~- ~o~[Tab] to search groups',tOASIS.getRageUIMenuWidth(), tOASIS.getRageUIMenuHeight(),"banners", "admin"))
RMenu.Add("adminmenu", "addgroup", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "groups"), "", menuColour..'Admin Groups Menu',tOASIS.getRageUIMenuWidth(), tOASIS.getRageUIMenuHeight(),"banners", "admin"))
RMenu.Add("adminmenu", "removegroup", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "groups"), "", menuColour..'Admin Groups Menu',tOASIS.getRageUIMenuWidth(), tOASIS.getRageUIMenuHeight(),"banners", "admin"))
...
RegisterNetEvent("OASIS:ReturnNearbyPlayers")
AddEventHandler("OASIS:ReturnNearbyPlayers", function(table)
    playersNearby = table
end)
...
Citizen.CreateThread(function()
    while true do
        ...
        if hoveredPlayer ~= nil then
            local playerCoords = GetEntityCoords(tOASIS.getPlayerPed())
            if tOASIS.isInSpectate() then
                playerCoords = GetFinalRenderedCamCoord()
            end
            TriggerServerEvent("OASIS:GetNearbyPlayers", playerCoords, 250)
            Citizen.Wait(1000)
        end
    end
end)
...
RageUI.CreateWhile(1.0, true, function()
    if tOASIS.getStaffLevel() >= 1 then
    ...
    if RageUI.Visible(RMenu:Get('adminmenu', 'players')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = false}, function()
            for k, v in pairs(players) do
                if not tOASIS.isUserHidden(v[3]) then
                    RageUI.ButtonWithStyle(v[1] .." ["..v[2].."]", v[1] .. " ("..v[4].." hours) PermID: " .. v[3] .. " TempID: " .. v[2], {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                        if Selected then
                            ...
                            SelectedPerm = v[3]
                            TriggerServerEvent("OASIS:CheckPov",v[3])
                        end
        ...
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = false}, function()
            if tOASIS.getStaffLevel() >= 1 then
                RageUI.ButtonWithStyle("Get Coords", "", {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent('OASIS:GetCoords')
                    end
                end)                 
                RageUI.List("Teleport",q,s,"",{},true,function(x, y, z, N)
                    s = N
                    if z then
                        tOASIS.teleport2(vector3(r[s]), true)
                    end
                end,
                function()end)
            end
            if tOASIS.getStaffLevel() >= 5 then
                RageUI.ButtonWithStyle("TP To Coords","",{RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent("OASIS:Tp2Coords")
                    end
                end)
            end
            if tOASIS.getStaffLevel() >= 2 then
                RageUI.ButtonWithStyle("Offline Ban","",{RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        tOASIS.clientPrompt("Perm ID:","",function(a)
                            banningPermID = a
                            ...
                            TriggerServerEvent('OASIS:getNotes', banningPermID)
                        end)
                    end
                ...
                RageUI.ButtonWithStyle("TP To Waypoint", "", {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        ...
                        if DoesBlipExist(WaypointHandle) then
                            ...
                            tOASIS.notify("~r~You do not have a waypoint set")
                        end
                    end
                end)
            end
            if tOASIS.getStaffLevel() >= 5 then
                RageUI.ButtonWithStyle("Unban","",{RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent("OASIS:Unban")
                    end
                end)
            end
            if tOASIS.getStaffLevel() >= 3 then
                RageUI.ButtonWithStyle("Spawn Taxi", "", {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        local A = GetEntityCoords(tOASIS.getPlayerPed())
                        tOASIS.spawnVehicle("taxi",A.x,A.y,A.z,GetEntityHeading(tOASIS.getPlayerPed()),true,true,true)
                    end
                end)
            end
            if tOASIS.getStaffLevel() >= 5 then
                    ...
                    if Selected then
                        ...
                        for E, S in pairs(GetActivePlayers()) do
                            ...
                            if T ~= -1 and M ~= 0 then
                                ...
                                if #(D - U) < 50.0 then
                                    local V = tOASIS.clientGetUserIdFromSource(T)
                                    if V > 0 then
                                        TriggerServerEvent('OASIS:RevivePlayer', GetPlayerServerId(PlayerId()), V, true)
                                    end
                                end
                            end
                        end
                ...
                RageUI.ButtonWithStyle("Remove Warning","",{RightLabel="→→→"},true,function(Hovered, Active, Selected)
                    if Selected then
                        ...
                        if (GetOnscreenKeyboardResult()) then
                            ...
                            if result then 
                                TriggerServerEvent('OASIS:RemoveWarning', result)
                            end
                        end
                    end
                end)
            ...
            if tOASIS.getStaffLevel() >= 10 then
                ...
                RageUI.ButtonWithStyle("Add Car", "", {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent('OASIS:AddCar')
                    end
                end, RMenu:Get('adminmenu', 'functions'))
                RageUI.Checkbox("Set Globally Hidden","",tOASIS.isLocalPlayerHidden(),{},function()
                end,function()
                    TriggerServerEvent("OASIS:setUserHidden", true)
                end,function()
                    TriggerServerEvent("OASIS:setUserHidden", false)
                end)
            end
        end)
    end
        ...
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = false}, function()
            if a10 ~= nil and sn ~= nil and sc ~= nil and sb ~= nil and sw ~= nil and sch ~= nil then
                ...
                RageUI.ButtonWithStyle("Bank Balance ~g~+",nil,{RightLabel="→→→"},true,function(w,x,y)
                    if y then
                        tOASIS.clientPrompt("Amount:","",function(j)
                            if tonumber(j) then
                                TriggerServerEvent('OASIS:ManagePlayerBank',a10,j,"Increase")
                            else
                                tOASIS.notify("~r~Invalid Amount")
                            end
                        end)
                    end
                end)
                RageUI.ButtonWithStyle("Bank Balance ~r~-",nil,{RightLabel="→→→"},true,function(w,x,y)
                    if y then
                        tOASIS.clientPrompt("Amount:","",function(j)
                            if tonumber(j) then
                                TriggerServerEvent('OASIS:ManagePlayerBank',a10,j,"Decrease")
                            else
                                tOASIS.notify("~r~Invalid Amount")
                            end
                        end)
                ...
                RageUI.ButtonWithStyle("Cash Balance ~g~+~w~",nil,{RightLabel="→→→"},true,function(w,x,y)
                    if y then
                        tOASIS.clientPrompt("Amount:","",function(l)
                            if tonumber(l) then
                                TriggerServerEvent('OASIS:ManagePlayerCash',a10,l,"Increase")
                            else
                                tOASIS.notify("~r~Invalid Amount")
                            end
                        end)
                ...
                RageUI.ButtonWithStyle("Cash Balance ~r~-",nil,{RightLabel="→→→"},true,function(w,x,y)
                    if y then
                        tOASIS.clientPrompt("Amount:","",function(l)
                            if tonumber(l) then
                                TriggerServerEvent('OASIS:ManagePlayerCash',a10,l,"Decrease")
                            else
                                tOASIS.notify("~r~Invalid Amount")
                            end
                        end)
                ...
                RageUI.ButtonWithStyle("Casino Chips ~g~+",nil,{RightLabel="→→→"},true,function(w,x,y)
                    if y then
                        tOASIS.clientPrompt("Amount:","",function(l)
                            if tonumber(l) then
                                TriggerServerEvent('OASIS:ManagePlayerChips',a10,l,"Increase")
                            else
                                tOASIS.notify("~r~Invalid Amount")
                            end
                        end)
                ...
                RageUI.ButtonWithStyle("Casino Chips ~r~-",nil,{RightLabel="→→→"},true,function(w,x,y)
                    if y then
                        tOASIS.clientPrompt("Amount:","",function(l)
                            if tonumber(l) then
                                TriggerServerEvent('OASIS:ManagePlayerChips',a10,l,"Decrease")
                            else
                                tOASIS.notify("~r~Invalid Amount")
                            end
                        end)
            ...
            RageUI.ButtonWithStyle("Choose PermID",nil, { RightLabel = "→→→" }, true, function(w,x,y)
                if y then
                    tOASIS.clientPrompt("PermID:","",function(j)
                        if tonumber(j) then
                            a10 = tonumber(j)
                            tOASIS.notify("~g~PermID Set To "..j)
                            TriggerServerEvent('OASIS:getUserinformation',a10)
                        else
                            tOASIS.notify("~r~Invalid PermID")
                            a10 = nil
                        end
                    end)
                end
    ...
    if RageUI.Visible(RMenu:Get('adminmenu', 'communitypot')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = false}, function()
            ...
            RageUI.ButtonWithStyle("Deposit","",{RightLabel="→→→"},true,function(e,f,g)
                if g then 
                    tOASIS.clientPrompt("Enter Amount:","",function(d)
                        if tonumber(d)then 
                            TriggerServerEvent("OASIS:tryDepositCommunityPot",d)
                        else 
                            tOASIS.notify("~r~Invalid amount.")
                        end 
                    end)
            ...
            RageUI.ButtonWithStyle("Withdraw","",{RightLabel="→→→"},true,function(e,f,g)
                if g then 
                    tOASIS.clientPrompt("Enter Amount:","",function(d)
                        if tonumber(d)then 
                            TriggerServerEvent("OASIS:tryWithdrawCommunityPot",d)
                        else 
                            tOASIS.notify("~r~Invalid amount.")
                        end 
                    end)
    ...
    if RageUI.Visible(RMenu:Get('adminmenu', 'searchpermid')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = false}, function()
            if foundMatch == false then
                searchforPermID = tOASIS.KeyboardInput("Enter Perm ID", "", 10)
    ...
    if RageUI.Visible(RMenu:Get('adminmenu', 'searchtempid')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = false}, function()
            if foundMatch == false then
                searchid = tOASIS.KeyboardInput("Enter Temp ID", "", 10)
    ...
    if RageUI.Visible(RMenu:Get('adminmenu', 'searchname')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = false}, function()
            if foundMatch == false then
                SearchName = tOASIS.KeyboardInput("Enter Name", "", 10)
    ...
    if RageUI.Visible(RMenu:Get('adminmenu', 'submenu')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = false}, function()
            hoveredPlayer = nil
            if tOASIS.isUserHidden(SelectedPlayer[3]) then
            ...
            if tOASIS.getStaffLevel() >= 1 then
                RageUI.ButtonWithStyle("Player Notes", SelectedPlayer[1] .. " Perm ID: " .. SelectedPlayer[3] .. " Temp ID: " .. SelectedPlayer[2], {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent('OASIS:getNotes', SelectedPlayer[3])
                    end
                ...
                RageUI.ButtonWithStyle("Kick Player", SelectedPlayer[1] .. " Perm ID: " .. SelectedPlayer[3] .. " Temp ID: " .. SelectedPlayer[2], {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        ...
                        TriggerServerEvent('OASIS:KickPlayer', uid, SelectedPlayer[3], SelectedPlayer[2])
                    end
                end, RMenu:Get('adminmenu', 'submenu'))
            end
            if tOASIS.getStaffLevel() >= 2 then
                ...
                RageUI.ButtonWithStyle("Spectate Player", SelectedPlayer[1] .. " Perm ID: " .. SelectedPlayer[3] .. " Temp ID: " .. SelectedPlayer[2], {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        if tonumber(SelectedPlayer[2]) ~= GetPlayerServerId(PlayerId()) then
                            if not tOASIS.isInSpectate() then
                                inRedZone = false
                                TriggerServerEvent("OASIS:spectatePlayer", SelectedPlayer[3])
                                inSpectatorAdminMode = true
                                RageUI.Text({message = string.format("~r~Press [E] to stop spectating.")})
                            else
                                tOASIS.notify("~r~You are already spectating a player.")
                            end
                        else
                            tOASIS.notify("~r~You cannot spectate yourself.")
                        end
                    end
                end, RMenu:Get('adminmenu', 'submenu'))
            end
            if tOASIS.getStaffLevel() >= 3 then
                RageUI.ButtonWithStyle("Revive", SelectedPlayer[1] .. " Perm ID: " .. SelectedPlayer[3] .. " Temp ID: " .. SelectedPlayer[2], {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        local uid = GetPlayerServerId(PlayerId())
                        TriggerServerEvent('OASIS:RevivePlayer', uid, SelectedPlayer[3])
                    end
                end, RMenu:Get('adminmenu', 'submenu'))
            end
            if tOASIS.getStaffLevel() >= 1 then
                RageUI.ButtonWithStyle("Teleport to Player", "Name: " .. SelectedPlayer[1] .. " Perm ID: " .. SelectedPlayer[3] .. " Temp ID: " .. SelectedPlayer[2], {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        ...
                        TriggerServerEvent('OASIS:TeleportToPlayer', newSource, SelectedPlayer[2])
                    end
                end, RMenu:Get('adminmenu', 'submenu'))
                RageUI.ButtonWithStyle("Teleport Player to Me", "Name: " .. SelectedPlayer[1] .. " Perm ID: " .. SelectedPlayer[3] .. " Temp ID: " .. SelectedPlayer[2], {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent('OASIS:BringPlayer', SelectedPlayer[2])
                    end
                end, RMenu:Get('adminmenu', 'submenu'))
                RageUI.ButtonWithStyle("Teleport to Admin Zone", SelectedPlayer[1] .. " Perm ID: " .. SelectedPlayer[3] .. " Temp ID: " .. SelectedPlayer[2], {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        ...
                        TriggerServerEvent("OASIS:Teleport2AdminIsland", SelectedPlayer[2])
                    end
                end, RMenu:Get('adminmenu', 'submenu'))
                RageUI.ButtonWithStyle("Teleport Back from Admin Zone", SelectedPlayer[1] .. " Perm ID: " .. SelectedPlayer[3] .. " Temp ID: " .. SelectedPlayer[2], {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent("OASIS:TeleportBackFromAdminZone", SelectedPlayer[2], savedCoordsBeforeAdminZone)
                    end
                end, RMenu:Get('adminmenu', 'submenu'))
                RageUI.ButtonWithStyle("Teleport to Legion", SelectedPlayer[1] .. " Perm ID: " .. SelectedPlayer[3] .. " Temp ID: " .. SelectedPlayer[2], {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent("OASIS:Teleport2Legion", SelectedPlayer[2])
                    end
                end, RMenu:Get('adminmenu', 'submenu'))
                RageUI.ButtonWithStyle("Freeze", SelectedPlayer[1] .. " Perm ID: " .. SelectedPlayer[3] .. " Temp ID: " .. SelectedPlayer[2], {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        ...
                        TriggerServerEvent('OASIS:FreezeSV', uid, SelectedPlayer[2], isFrozen)
                    end
                end, RMenu:Get('adminmenu', 'submenu'))
            end
            if tOASIS.getStaffLevel() >= 5 then
                RageUI.ButtonWithStyle("Slap Player", SelectedPlayer[1] .. " Perm ID: " .. SelectedPlayer[3] .. " Temp ID: " .. SelectedPlayer[2], {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        local uid = GetPlayerServerId(PlayerId())
                        TriggerServerEvent('OASIS:SlapPlayer', uid, SelectedPlayer[2])
                    end
                end, RMenu:Get('adminmenu', 'submenu'))
                RageUI.ButtonWithStyle("Force Clock Off", SelectedPlayer[1] .. " Perm ID: " .. SelectedPlayer[3] .. " Temp ID: " .. SelectedPlayer[2], {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent('OASIS:ForceClockOff', SelectedPlayer[2])
                    end
                end, RMenu:Get('adminmenu', 'submenu'))
            end
            if tOASIS.getStaffLevel() >= 1 then
            ...
            if tOASIS.getStaffLevel() >= 2 then
                RageUI.ButtonWithStyle("Take Screenshot", SelectedPlayer[1] .. " Perm ID: " .. SelectedPlayer[3] .. " Temp ID: " .. SelectedPlayer[2], {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        local uid = GetPlayerServerId(PlayerId())
                        TriggerServerEvent('OASIS:RequestScreenshot', uid , SelectedPlayer[2])
                    end
                end, RMenu:Get('adminmenu', 'submenu'))
                RageUI.Button("Take Video", SelectedPlayer[1] .. " Perm ID: " .. SelectedPlayer[3] .. " Temp ID: " .. SelectedPlayer[2], requestedVideo and {RightLabel = ""} or {RightLabel = "→→→"}, not requestedVideo, function(Hovered, Active, Selected)
                    if Selected then
                        local uid = GetPlayerServerId(PlayerId())
                        TriggerServerEvent('OASIS:RequestVideo', uid, SelectedPlayer[2])
                        requestedVideo = true
            ...
            if tOASIS.getStaffLevel() >= 6 then
                RageUI.ButtonWithStyle("Request Account Info", SelectedPlayer[1] .. " Perm ID: " .. SelectedPlayer[3] .. " Temp ID: " .. SelectedPlayer[2], {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent("OASIS:requestAccountInfosv", SelectedPlayer[3])
                    end
                end,RMenu:Get("adminmenu", "submenu"))
                RageUI.ButtonWithStyle("See Groups", SelectedPlayer[1] .. " Perm ID: " .. SelectedPlayer[3] .. " Temp ID: " .. SelectedPlayer[2], {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent("OASIS:GetGroups", SelectedPlayer[3])
                        tt=''
                    end
                end,RMenu:Get("adminmenu", "groups"))
            end
            if tOASIS.getStaffLevel() >= 12 then
                RageUI.ButtonWithStyle("Commit Godly Wrath on Player","",{RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent("OASIS:zapPlayer", SelectedPlayer[2])
                    end
                end,RMenu:Get("adminmenu", "submenu"))
            end
        end)
        ...
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = false}, function()
            if tOASIS.getStaffLevel() >= 2 then
                if IsControlJustPressed(0, 37) then
                    tOASIS.clientPrompt("Search for: ","",function(O)
                        if O ~= "" then
                            o = string.lower(O)
                        else
                            o = nil
                ...
                RageUI.ButtonWithStyle("Confirm Ban", "", {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent("OASIS:GenerateBan", banningPermID, selectedbans)
                    end
                ...
                if next(selectedbans) then
                    if BanMessage == "N/A" then
                        ...
                        RageUI.ButtonWithStyle("Confirm", "", {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                            if Selected then
                                TriggerServerEvent("OASIS:BanPlayer", banningPermID, Duration, BanMessage, BanPoints)
                            end
                        end)
                    end
                else
        ...
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = false}, function()
            ...
            if tOASIS.getStaffLevel() >= 1 then
                RageUI.ButtonWithStyle("Add To Notes:", SelectedPlayer[1] .. " Perm ID: " .. SelectedPlayer[3] .. " Temp ID: " .. SelectedPlayer[2], { RightLabel = "→→→" }, true, function(Hovered, Active, Selected)
                    if Selected then
                        tOASIS.clientPrompt("Add To Notes: ","",function(a7)
                            if a7 ~= "" then
                                if #noteslist ~= 0 then
                                    noteslist[#noteslist + 1] = {id = #noteslist + 1, note = a7, author = tOASIS.getUserId()}
                                else
                                    noteslist = {{id = 1, note = a7, author = tOASIS.getUserId()}}
                                end
                                TriggerServerEvent("OASIS:updatePlayerNotes", SelectedPlayer[3], noteslist)
                            end
                        end)
                    end
                end)
                RageUI.ButtonWithStyle("Remove Note", nil, { RightLabel = "→→→" }, true, function(Hovered, Active, Selected)
                    if Selected then
                        tOASIS.clientPrompt("Type the ID of the note","",function(a7)
                            if a7 ~= "" then
                                a7 = tonumber(a7)
                                local a8 = {}
                                local a9 = false
                                ...
                                if a9 == true then
                                    ...
                                    TriggerServerEvent("OASIS:updatePlayerNotes", SelectedPlayer[3], a8)
                                end
                            end
                        end)
                    end
    ...
    if RageUI.Visible(RMenu:Get('adminmenu', 'groups')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = false}, function()
            if tOASIS.getStaffLevel() >= 7 then
                if IsControlJustPressed(0, 37) then
                    tOASIS.clientPrompt("Search for: ","",function(S)
                        tt=string.lower(S)
                    end)
                end
    ...
    if RageUI.Visible(RMenu:Get('adminmenu', 'addgroup')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = false}, function()
            RageUI.ButtonWithStyle("Add this group to user", "", { RightLabel = "→→→" }, true, function(Hovered, Active, Selected)
                if Selected then
                    TriggerServerEvent("OASIS:AddGroup",SelectedPerm,selectedGroup)
                end
            end, RMenu:Get('adminmenu', 'groups'))
        end)
    end
    if RageUI.Visible(RMenu:Get('adminmenu', 'removegroup')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = false}, function()
            RageUI.ButtonWithStyle("Remove user from group", "", { RightLabel = "→→→" }, true, function(Hovered, Active, Selected)
                if Selected then
                    TriggerServerEvent("OASIS:RemoveGroup",SelectedPerm,selectedGroup)
                end
            end, RMenu:Get('adminmenu', 'groups')) 
        end)
    end
...
RegisterCommand("cleanup", function()
    TriggerServerEvent('OASIS:CleanAll')
end)

RegisterNetEvent('OASIS:SlapPlayer')
AddEventHandler('OASIS:SlapPlayer', function()
    SetEntityHealth(PlayerPedId(), 0)
end)


frozen = false
RegisterNetEvent("OASIS:Freeze",function()
    local Q = tOASIS.getPlayerPed()
    ...
    if not frozen then
        ...
        frozen = true
        while frozen do
            tOASIS.setWeapon(Q, "WEAPON_UNARMED", true)
            Wait(0)
        end
    else
...
RegisterNetEvent("OASIS:sendNotes",function(a7)
    a7 = json.decode(a7)
    if a7 == nil then
        noteslist = {}
    else
...
RegisterNetEvent('OASIS:ReturnPov')
AddEventHandler('OASIS:ReturnPov', function(pov)
    povlist = pov
end)

RegisterNetEvent("OASIS:GotGroups")
AddEventHandler("OASIS:GotGroups",function(gotGroups)
    searchPlayerGroups = gotGroups
end)

RegisterNetEvent("OASIS:getPlayersInfo")
AddEventHandler("OASIS:getPlayersInfo", function(BB, preasons)
    players = BB
    banreasons = preasons
    RageUI.Visible(RMenu:Get("adminmenu", "main"), not RageUI.Visible(RMenu:Get("adminmenu", "main")))
end)

RegisterNetEvent("OASIS:RecieveBanPlayerData")
AddEventHandler("OASIS:RecieveBanPlayerData",function(BanDuration, CollectedBanMessage, SepMSG, points)
...
RegisterNetEvent("OASIS:receivedUserInformation")
AddEventHandler("OASIS:receivedUserInformation", function(us,un,ub,uw,uc)
    if us == nil or un == nil or ub == nil or uw == nil or uc == nil then
        a10 = nil
        tOASIS.notify("Player does not exist.")
        return
    end
    sc=us
    sn=un
...
RegisterNetEvent("OASIS:gotCommunityPotAmount",function(d)
...
RegisterNetEvent('OASIS:OpenAdminMenu')
AddEventHandler('OASIS:OpenAdminMenu', function(admin)
    if admin then
        TriggerServerEvent('OASIS:GetPlayerData')
        TriggerServerEvent("OASIS:GetNearbyPlayerData")
        TriggerServerEvent("OASIS:getAdminLevel")
    end
end)
...
function func_checkSpectatorMode()
    if inSpectatorAdminMode then
        if IsControlJustPressed(0, 51) then
            ...
            TriggerServerEvent("OASIS:stopSpectatePlayer")
        end
    end
end
tOASIS.createThreadOnTick(func_checkSpectatorMode)


RegisterNetEvent("OASIS:takeClientScreenshotAndUpload",function(url)
    local url = url -- need a custom uploader whenever
    exports["screenshot-basic"]:requestScreenshotUpload(url,"files[]",function(ab)
    end)
end)

RegisterNetEvent("OASIS:takeClientVideoAndUpload",function(url)
    local url = url  -- need a custom uploader whenever
...
local function ao()
    ...
    if GetGameTimer() - an > 60000 then
        TriggerServerEvent("OASIS:acType16")
    end
end
AddEventHandler("OASIS:onClientSpawn",function(C, D)
    if D then
        an = GetGameTimer()
        while true do
            ao()
