...
-- local a = false
-- RMenu.Add("lfb","main",RageUI.CreateMenu("","Status: ~g~Available",tOASIS.getRageUIMenuWidth(),tOASIS.getRageUIMenuHeight(),"banners", "lfb"))
-- RMenu.Add("lfb","tools",RageUI.CreateSubMenu(RMenu:Get("lfb", "main"),"","LFB: ~b~Tools",tOASIS.getRageUIMenuWidth(),tOASIS.getRageUIMenuHeight()))
-- RMenu.Add("lfb","water",RageUI.CreateSubMenu(RMenu:Get("lfb", "main"),"","LFB: ~b~Water",tOASIS.getRageUIMenuWidth(),tOASIS.getRageUIMenuHeight()))
-- RMenu.Add("lfb","ba",RageUI.CreateSubMenu(RMenu:Get("lfb", "main"),"","LFB: ~b~BA",tOASIS.getRageUIMenuWidth(),tOASIS.getRageUIMenuHeight()))
-- RMenu.Add("lfb","firemain",RageUI.CreateMenu("", "Manage Fires", tOASIS.getRageUIMenuWidth(), tOASIS.getRageUIMenuHeight(), "banners", "lfb"))
-- RMenu.Add("lfb","fire",RageUI.CreateSubMenu(RMenu:Get("lfb", "firemain"),"","LFB: ~b~Start Fires",tOASIS.getRageUIMenuWidth(),tOASIS.getRageUIMenuHeight()))
-- RMenu.Add("lfb","management",RageUI.CreateSubMenu(RMenu:Get("lfb", "firemain"),"","LFB: ~b~Manage Fires",tOASIS.getRageUIMenuWidth(),tOASIS.getRageUIMenuHeight()))
-- RMenu.Add("lfb","settings",RageUI.CreateSubMenu(RMenu:Get("lfb", "firemain"),"","LFB: ~b~Settings",tOASIS.getRageUIMenuWidth(),tOASIS.getRageUIMenuHeight()))
...
--                     function(b, c, d)
--                         if d then
--                             tOASIS.loadCustomisationPreset("NoBreathingApperatus")
--                         end
--                     end
--                 )
--                 RageUI.Button(
...
--                     function(b, c, d)
--                         if d then
--                             tOASIS.loadCustomisationPreset("BreathingApperatusDown")
--                         end
--                     end
--                 )
--                 RageUI.Button(
...
--                     function(b, c, d)
--                         if d then
--                             tOASIS.loadCustomisationPreset("BreathingApperatusUp")
--                         end
--                     end
--                 )
--             end,
...
--                     function(b, c, d)
--                         if d then
--                             TriggerServerEvent("OASIS:updateFireOptions", l, n, m)
--                         end
--                     end
--                 )
--             end,
...
--                     function(b, c, d)
--                         if d then
--                             TriggerServerEvent("OASIS:stopAllFires")
--                         end
--                     end
--                 )
--             end,
...
--                             TriggerServerEvent("OASIS:updateFireTableServer", s, u, false, false, true)
--                         end
--                     end
--                 )
--             end,
...
--     end
-- )
-- TriggerServerEvent("OASIS:receiveLFBTablesServer")
-- local v = {}
-- local w = {}
-- local x = {}
-- local y = {}
...
--     return tOASIS.generateUUID("fire", 20, "alphanumeric")
-- end
-- RegisterNetEvent("OASIS:startFireMenu",function(F, G, H)
--     RageUI.ActuallyCloseAll()
--     RageUI.Visible(RMenu:Get("lfb", "tools"), false)
--     RageUI.Visible(RMenu:Get("lfb", "main"), false)
--     RageUI.Visible(RMenu:Get("lfb", "water"), false)
...
-- RegisterNetEvent("OASIS:receiveLFBTables",function(I, J, K, L, M, N, O, P, Q)
--     v = I
--     w = J
--     x = K
--     y = L
...
-- RegisterNetEvent("OASIS:updateFireTable",function(R, S, T, U)
--     if T then
...
--     v[R].active = true
--     tOASIS.loadPtfx(f[v[R].type].dict)
...
--         tOASIS.loadPtfx(E[f[v[R].type].smokeType].dict)
...
-- }
-- RegisterNetEvent("OASIS:updateSupplyLineTable",function(R, S, T)
--     if T then
--         w[R] = nil
--         return
--     end
...
--     local a4 = tOASIS.getPlayerPed()
--     local ae = tOASIS.getPlayerVehicle()
--     if ae ~= 0 then
--         tOASIS.notify("~r~Error~w~: You must not be inside a vehicle")
--         return
--     end
...
--         if ad then
--             if ag then
--                 tOASIS.notify("~r~Error~w~: A supply line is already setup on this vehicle")
--             else
...
--                         Wait(0)
--                     end
--                     TriggerServerEvent("OASIS:createLFBPropLog", "Supply Line", GetEntityCoords(aj, true))
...
--                     w[af] = {af, al, t}
--                     TriggerServerEvent("OASIS:updateSupplyLineTable", af, w[af], false)
--                     SetModelAsNoLongerNeeded(a2)
--                     tOASIS.notify("~g~Success~w~: Supply line setup")
--                 else
--                     tOASIS.notify("~r~Error~w~: You cannot setup a supply line on this vehicle")
--                 end
--             end
--         else
--             if ag then
--                 TriggerServerEvent("OASIS:updateSupplyLineTable", af, w[af], true)
--                 TriggerServerEvent("OASIS:lfbDeleteSupplyLine", w[af][2])
--                 TriggerServerEvent("OASIS:removeVehicleStablisers", af)
--                 w[af] = nil
--                 tOASIS.notify("~g~Success~w~: Supply line removed")
--             else
--                 tOASIS.notify("~g~Success~w~: No supply line found")
--             end
--         end
--     else
--         tOASIS.notify("~r~Error~w~: No vehicle found")
--     end
-- end
-- local am = 200
-- local an = {}
...
-- local ap = false
-- RegisterNetEvent("OASIS:hoseUpdate",function(aq, ar, T)
--     if T then
--         if an[aq] ~= nil then
--             an[aq][3] = false
--             if an[aq][4] ~= nil then
...
--                 if as == GetHashKey(ao) and IsPlayerFreeAiming(tOASIS.getPlayerId()) then
--                     a0 = true
...
--                             handleHose()
--                         else
--                             tOASIS.notify("~r~Notice~w~: You have no active supply of water")
--                         end
--                     end
--                 end
--             end
...
--             if i[3] then
--                 local ar = DecorGetFloat(tOASIS.getObjectId(i[1]), "HosePitch")
--                 if i[4] ~= nil then
...
--     local at = tOASIS.getObjectId(an[aq][1], "hoseParticle")
--     local t = GetEntityCoords(at)
--     if #(tOASIS.getPlayerCoords() - t) < 100.0 and GetSelectedPedWeapon(at) == GetHashKey(ao) then
...
-- function handleHose()
--     local a4 = tOASIS.getPlayerPed()
--     local aq = tOASIS.getNetId(a4, "handleHose()")
--     TriggerServerEvent("OASIS:hoseUpdateServer", aq, 0.0, false)
--     ap = true
--     while ap do
--         DisableControlAction(0, 24, true)
...
--         putOutFires()
--         if not IsDisabledControlPressed(0, 24) or tOASIS.getPlayerVehicle() ~= 0 or IsPauseMenuActive() or GetSelectedPedWeapon(a4) ~= GetHashKey(ao) or not IsPlayerFreeAiming(tOASIS.getPlayerId()) or not X and _ < 1 then
--             ap = false
--             TriggerServerEvent("OASIS:hoseUpdateServer", aq, 0.0, true)
--         end
--         Wait(0)
--     end
-- end
...
--             local a6 = GetOffsetFromEntityInWorldCoords(tOASIS.getPlayerPed(), 0.0, 3.0, 0.5)
--             if #(a6 - i.coords) < 7.0 then
--                 local av = math.random(1, f[i.type].chance)
--                 if av == 1 then
--                     local H = i.size * 0.92
--                     if H < 0.5 then
--                         TriggerServerEvent("OASIS:updateFireTableServer", h, v[h], true, false)
--                         Wait(5000)
--                     else
--                         v[h].size = H
--                         TriggerServerEvent("OASIS:updateFireTableServer", h, v[h], false, true)
--                         Wait(5000)
--                     end
--                     break
--                 end
...
--     end
-- end
-- RegisterNetEvent("OASIS:updateMonitorsTable",function(R, S, T)
--     if T then
--         x[R] = nil
--         return
--     end
...
-- RegisterNetEvent("OASIS:toggleWaterClient",function(R)
--     if x[R] ~= nil then
--         x[R][4] = not x[R][4]
--     end
...
--             Wait(0)
--         end
--         TriggerServerEvent("OASIS:createLFBPropLog", "Water Monitor", GetEntityCoords(aj, true))
...
--         TriggerServerEvent("OASIS:updateMonitorsTable", al, x[al], false)
--         SetModelAsNoLongerNeeded(ax)
--         tOASIS.notify("~g~Success~w~: Water monitor setup")
--     else
--         local ai = false
--         local ay = 0
--         for h, i in pairs(x) do
...
--         if ai then
--             if x[ay][4] then
--                 tOASIS.notify("~r~Error~w~: This monitor is active and cannot be removed")
--             else
--                 local aj = tOASIS.getObjectId(x[ay][1], "handleWaterMonitor")
--                 TriggerServerEvent("OASIS:updateMonitorsTable", ay, x[ay], true)
--                 if DoesEntityExist(aj) then
--                     DeleteEntity(aj)
--                 end
--                 x[ay] = nil
--                 tOASIS.notify("~g~Success~w~: Water monitor removed")
--             end
--         else
--             tOASIS.notify("~r~Error~w~: No water monitor found")
--         end
--     end
-- end
-- RegisterNetEvent("OASIS:adjustPitchClient",function(R, az)
--     if aw[R] ~= nil and aw[R].handle ~= nil and DoesParticleFxLoopedExist(aw[R].handle) then
--         local t = x[R][2]
--         StopParticleFxLooped(aw[R].handle, false)
--         StopParticleFxLooped(aw[R].handle2, false)
...
--                                 end
--                                 if az ~= 0.0 then
--                                     TriggerServerEvent("OASIS:adjustPitchServer", h, az)
--                                     Wait(1000)
--                                 end
--                                 DisableControlAction(0, 38, true)
--                                 if IsDisabledControlPressed(0, 38) then
--                                     pressed = true
--                                     TriggerServerEvent("OASIS:toggleWaterServer", h)
--                                     tOASIS.notify("~g~Success~w~: Water monitor toggled")
--                                     Wait(aC * 1000)
--                                 end
--                             else
...
--                                     end
--                                 else
--                                     tOASIS.notify("~r~Error~w~: No active supply line found to enable this water monitor")
--                                 end
--                             end
--                         else
--                             if supplyLineNearby(t) then
...
--                                     X = true
--                                     Y = h
--                                     tOASIS.notify("~g~Success~w~: You are now connected to this vehicle")
--                                     aF = true
--                                     _ = am
--                                     break
--                                 end
...
--                                             Z[af] = nil
--                                         end)
--                                         tOASIS.notify("~g~Success~w~: You now have a limited supply of water from the nearest vehicle")
--                                     end
--                                 else
--                                     if _ < 1 then
--                                         tOASIS.notify("~r~Notice~w~: This vehicle has already supplied you with water, setup a supply line for more")
--                                         Wait(5000)
--                                     end
--                                 end
--                             end
...
--                 if Y ~= 0 then
--                     if w[Y] == nil then
--                         tOASIS.notify("~r~Notice~w~: You have now been disconnected from the supply line")
--                         X = false
--                     end
--                 end
--                 if X then
...
--     end
-- end
-- tOASIS.createThreadOnTick(func_displayHoseLeft)
-- local aI = {}
-- local aJ = 2.0
-- RegisterNetEvent("OASIS:toggleWaterTents",function(R)
--     if y[R] ~= nil then
--         y[R][8] = not y[R][8]
--     end
...
--             Wait(0)
--         end
--         TriggerServerEvent("OASIS:createLFBPropLog", "Decontamination Tent", GetEntityCoords(aj, true))
--         local al = NetworkGetNetworkIdFromEntity(aj)
--         PlaceObjectOnGroundProperly(aj)
--         FreezeEntityPosition(aj, true)
--         SetEntityHeading(aj, GetEntityHeading(a4))
...
--         TriggerServerEvent("OASIS:updateTentsTable", al, y[al], false)
--         SetModelAsNoLongerNeeded(aK)
--         tOASIS.notify("~g~Success~w~: Decontamination tent setup")
--     else
--         local ai = false
--         local ay = 0
...
--         if ai then
--             if y[ay][8] then
--                 tOASIS.notify("~r~Error~w~: This decontamination tent is active and cannot be removed")
--             else
--                 local aj = tOASIS.getObjectId(y[ay][1], "handleDecontaminationTent")
--                 TriggerServerEvent("OASIS:updateTentsTable", ay, y[ay], true)
--                 if DoesEntityExist(aj) then
--                     DeleteEntity(aj)
--                 end
--                 y[ay] = nil
--                 tOASIS.notify("~g~Success~w~: Decontamination tent removed")
--             end
--         else
--             tOASIS.notify("~r~Error~w~: No decontamination tent found")
--         end
--     end
-- end
-- RegisterNetEvent("OASIS:updateTentsTable",function(R, S, T)
--     if T then
--         y[R] = nil
--         return
--     end
...
--                     DisableControlAction(0, 38, true)
--                     if IsDisabledControlPressed(0, 38) then
--                         TriggerServerEvent("OASIS:toggleWaterTents", h)
--                         tOASIS.notify("~g~Success~w~: Decontamination showers toggled")
--                     end
--                 end
--             end
--         end
...
-- RegisterNetEvent("OASIS:updateCushionsTable",function(R, S, T)
--     if T then
--         z[R] = nil
--         return
--     end
...
--             Wait(0)
--         end
--         TriggerServerEvent("OASIS:createLFBPropLog", "Rescue Cushion", GetEntityCoords(aj, true))
--         SetEntityCollision(aj, false, true)
--         PlaceObjectOnGroundProperly(aj)
--         FreezeEntityPosition(aj, true)
...
--         local al = NetworkGetNetworkIdFromEntity(aj)
--         z[al] = {al, a6}
--         TriggerServerEvent("OASIS:updateCushionsTable", al, z[al], false)
--         SetModelAsNoLongerNeeded(aR)
--         tOASIS.notify("~g~Success~w~: Rescue cushion setup")
--     else
--         local ai = false
--         local ay = 0
...
--         end
--         if ai then
--             TriggerServerEvent("OASIS:deleteProp", z[ay][1])
--             local aj = tOASIS.getObjectId(z[ay][1], "handleRescueCushion")
--             TriggerServerEvent("OASIS:updateCushionsTable", ay, z[ay], true)
--             if DoesEntityExist(aj) then
--                 DeleteEntity(aj)
--             end
--             z[ay] = nil
--             tOASIS.notify("~g~Success~w~: Rescue cushion removed")
--         else
--             tOASIS.notify("~r~Error~w~: No rescue cushion found")
--         end
--     end
-- end
-- local aS = false
...
--                                 SetPlayerFallDistance(tOASIS.getPlayerId(), 250.0)
--                                 heightSet = true
--                             else
--                                 SetPlayerFallDistance(tOASIS.getPlayerId(), 5.0)
--                             end
--                         else
--                             SetPlayerFallDistance(tOASIS.getPlayerId(), 5.0)
--                         end
...
--                                 local V = #(tOASIS.getPlayerCoords() - i[2])
--                                 if V < 4.0 then
...
-- end
-- )
-- RegisterNetEvent("OASIS:updateStabilisersTable",function(R, S, T)
--     if T then
--         A[R] = nil
--         return
--     end
--     A[R] = S
-- end)
-- RegisterNetEvent("OASIS:updateFansTable",function(R, S, T)
--     if T then
--         B[R] = nil
--         return
--     end
--     B[R] = S
-- end)
-- RegisterNetEvent("OASIS:stopRtcParticles",function(t)
--     Wait(20 * 1000)
-- end)
...
--     if not a then
--         tOASIS.loadModel(aV)
--         tOASIS.loadAnimDict("weapons@heavy@minigun")
...
--             TriggerServerEvent("OASIS:deleteProp", NetworkGetNetworkIdFromEntity(aW))
--             DetachEntity(a4)
--             DetachEntity(aW)
--             DeleteEntity(aW)
--             ClearPedTasks(a4)
...
--                             TriggerServerEvent("OASIS:rtcOpenDoor", ba, ak[b7][2], tOASIS.getPlayerCoords(), true)
--                             aD = true
--                         end
--                         if IsDisabledControlJustPressed(0, 191) then
--                             local ba = NetworkGetNetworkIdFromEntity(ae)
--                             TriggerServerEvent("OASIS:rtcOpenDoor", ba, ak[b7][2], tOASIS.getPlayerCoords(), false)
--                             aD = true
--                         end
--                         Wait(0)
--                     end
...
--     )
-- end
-- RegisterNetEvent("OASIS:rtcOpenDoor",function(ba, ak, t, bb)
--     local ae = tOASIS.getObjectId(ba, "OASIS:rtcOpenDoor")
...
--     end
-- end)
-- RegisterNetEvent("OASIS:spreadersSound",function(t)
--     local bc = tOASIS.getPlayerCoords()
--     local V = #(t - bc)
--     if V < 15.0 then
...
--         if ad then
--             if ag then
--                 tOASIS.notify("~r~Error~w~: Stabilisers are already setup on this vehicle")
--             else
--                 FreezeEntityPosition(ae, true)
--                 tOASIS.loadModel(bd)
--                 local t = GetEntityCoords(ae)
...
--                     Wait(0)
--                 end
--                 TriggerServerEvent("OASIS:createLFBPropLog", "Vehicle Stablisers", GetEntityCoords(aj, true))
--                 SetEntityCollision(aj, false, true)
...
--                 A[af] = {af, al, bl}
--                 TriggerServerEvent("OASIS:updateStabilisersTable", af, A[af], false)
--                 SetModelAsNoLongerNeeded(bd)
--                 tOASIS.notify("~g~Success~w~: Stabilisers setup")
--             end
--         else
--             if ag then
--                 local aj = tOASIS.getObjectId(A[af][2], "handleStabilisers 1")
--                 local bg = tOASIS.getObjectId(A[af][3], "handleStabilisers 2")
--                 TriggerServerEvent("OASIS:updateStabilisersTable", af, A[af], true)
--                 if DoesEntityExist(aj) then
--                     TriggerServerEvent("OASIS:deleteProp", NetworkGetNetworkIdFromEntity(aj))
--                     DeleteEntity(aj)
--                 end
--                 if DoesEntityExist(bg) then
--                     TriggerServerEvent("OASIS:deleteProp", NetworkGetNetworkIdFromEntity(bg))
--                     DeleteEntity(bg)
--                 end
--                 TriggerServerEvent("OASIS:removeVehicleStablisers", af)
--                 A[af] = nil
--                 tOASIS.notify("~g~Success~w~: Stabilisers removed")
--             else
--                 tOASIS.notify("~r~Error~w~: No stabilisers found")
--             end
--         end
--     else
--         tOASIS.notify("~r~Error~w~: No vehicle found")
--     end
-- end
-- RegisterNetEvent("OASIS:removeVehicleStablisers",function(bm)
...
--             Wait(0)
--         end
--         TriggerServerEvent("OASIS:createLFBPropLog", "Extractor Fan", GetEntityCoords(aj, true))
--         SetEntityCollision(aj, false, true)
--         local al = NetworkGetNetworkIdFromEntity(aj)
--         PlaceObjectOnGroundProperly(aj)
--         FreezeEntityPosition(aj, true)
--         B[al] = {al, a6}
--         TriggerServerEvent("OASIS:updateFansTable", al, B[al], false)
--         SetModelAsNoLongerNeeded(bn)
--         tOASIS.notify("~g~Success~w~: Fan setup")
--         TriggerServerEvent("OASIS:stopRtcParticles", t)
--     else
--         local ai = false
--         local ay = 0
...
--         end
--         if ai then
--             local aj = tOASIS.getObjectId(B[ay][1], "handleFan")
--             TriggerServerEvent("OASIS:updateFansTable", ay, B[ay], true)
--             if DoesEntityExist(aj) then
--                 TriggerServerEvent("OASIS:deleteProp", NetworkGetNetworkIdFromEntity(aj))
--                 DeleteEntity(aj)
--             end
--             B[ay] = nil
--             tOASIS.notify("~g~Success~w~: Fan removed")
--         else
--             tOASIS.notify("~r~Error~w~: No fan found")
--         end
--     end
-- end
-- local bo = false
...
--     end
-- end)
-- RegisterNetEvent("OASIS:updateJackTable",function(R, S, T)
--     if T then
--         C[R] = nil
--         return
--     end
--     C[R] = S
-- end)
-- RegisterNetEvent("OASIS:updateChockTable",function(R, S, T)
--     if T then
--         D[R] = nil
--         return
--     end
--     D[R] = S
-- end)
-- RegisterNetEvent("OASIS:toggleChockWheels",function(af)
--     local ae = tOASIS.getObjectId(af, "OASIS:toggleChockWheels")
--     if DoesEntityExist(ae) then
...
--             tOASIS.notify("~r~Error~w~: You are currently using a jack. Press ENTER to stop.")
--             return
--         end
--         if ad then
--             if ag then
--                 if not br then
--                     C[af][5] = true
--                     TriggerServerEvent("OASIS:updateJackTable", af, C[af], false)
--                     local bs = tOASIS.getObjectId(C[af][2], "handleJack 1")
--                     local bt = tOASIS.getObjectId(C[af][3], "handleJack 2")
--                     TriggerServerEvent("OASIS:deleteProp", NetworkGetNetworkIdFromEntity(bs))
--                     tOASIS.notify("~g~Success~w~: You're now controlling the inflatable jack")
--                     handleLifting(ae, af, bs)
--                 else
--                     tOASIS.notify("~r~Error~w~: This inflatable jack is in use")
--                 end
--             else
...
--                     Wait(0)
--                 end
--                 TriggerServerEvent("OASIS:createLFBPropLog", "Inflatable Jack", GetEntityCoords(bs, true))
...
--                 tOASIS.notify("~g~Success~w~: Inflatable jack setup")
--                 handleLifting(ae, af, bs)
--             end
--         else
--             if ag then
...
--                     tOASIS.notify("~r~Error~w~: This inflatable jack is in use")
--                 else
--                     local bs = tOASIS.getObjectId(C[af][2], "handleJack 3")
--                     local bt = tOASIS.getObjectId(C[af][3], "handleJack 4")
--                     TriggerServerEvent("OASIS:updateJackTable", af, C[af], true)
--                     if DoesEntityExist(bs) then
--                         TriggerServerEvent("OASIS:deleteProp", NetworkGetNetworkIdFromEntity(bs))
--                         DeleteEntity(bs)
--                     end
--                     if DoesEntityExist(bt) then
--                         TriggerServerEvent("OASIS:deleteProp", NetworkGetNetworkIdFromEntity(bt))
--                         DeleteEntity(bt)
--                     end
--                     TriggerServerEvent("OASIS:removeVehicleStablisers", af)
--                     C[af] = nil
--                     tOASIS.notify("~g~Success~w~: Inflatable jack removed")
--                 end
--             else
--                 tOASIS.notify("~r~Error~w~: No inflatable jack found")
--             end
--         end
--     else
--         tOASIS.notify("~r~Error~w~: No vehicle found")
...
--     tOASIS.notify("~g~Success~w~: Use ARROW UP and ARROW DOWN to adjust the height. Press ENTER when done")
--     local bz = C[af][4]
--     C[af][5] = true
...
--                 bz = 0.8
--             end
--             TriggerServerEvent("OASIS:lfbHandlingLifting", bm, by, bz)
--         end
...
--             TriggerServerEvent("OASIS:lfbLiftingFreeze", bm)
--             C[af][5] = false
--             C[af][4] = bz
--             TriggerServerEvent("OASIS:updateJackTable", af, C[af], false)
--             tOASIS.notify("~g~Success~w~: You've stopped controlling the inflatable jack")
--             usingCarJack = false
--         end
--         Wait(0)
--     end
-- end
-- RegisterNetEvent("OASIS:lfbHandlingLifting",function(bm, by, bz)
...
-- end)
-- RegisterNetEvent("OASIS:lfbLiftingFreeze",function(bm)
...
--         if ad then
--             if ag then
--                 tOASIS.notify("~r~Error~w~: This vehicle already has chocks setup")
--             else
--                 local bu = GetEntityCoords(ae)
--                 ResetVehicleWheels(ae, true)
--                 tOASIS.loadModel(bB)
--                 TriggerServerEvent("OASIS:toggleChockWheels", af)
...
--                     Wait(0)
--                 end
--                 TriggerServerEvent("OASIS:createLFBPropLog", "Air Chocks", GetEntityCoords(bC, true))
--                 local bh = GetEntityHeading(ae)
...
--                 D[af] = {af, bK, bL, bM, bN}
--                 TriggerServerEvent("OASIS:updateChockTable", af, D[af], false)
--                 SetModelAsNoLongerNeeded(bB)
--                 TaskGoStraightToCoord(tOASIS.getPlayerPed(), bu.x, bu.y, bu.z, 30.0, 0.5, 0.0, 10.0)
--                 Wait(2000)
--                 FreezeEntityPosition(ae, true)
--                 tOASIS.notify("~g~Success~w~: Car chocks setup")
--             end
--         else
--             if ag then
--                 Wait(2000)
--                 local bC = tOASIS.getObjectId(D[af][2], "chock1")
--                 local bD = tOASIS.getObjectId(D[af][3], "chock2")
--                 local bE = tOASIS.getObjectId(D[af][4], "chock3")
--                 local bF = tOASIS.getObjectId(D[af][5], "chock4")
--                 Wait(1000)
...
--                     DeleteEntity(bF)
--                 end
--                 TriggerServerEvent("OASIS:updateChockTable", af, D[af], true)
--                 TriggerServerEvent("OASIS:removeVehicleStablisers", af)
--                 tOASIS.notify("~g~Success~w~: Car chocks removed")
--             else
--                 tOASIS.notify("~r~Error~w~: No car chocks found")
--             end
--         end
--     else
--         tOASIS.notify("~r~Error~w~: No vehicle found")
...
--     end
--     if bP then
--         tOASIS.notify("~g~Success~w~: Throw bag deployed")
--         spawnRope(at)
--     else
--         tOASIS.notify("~r~Error~w~: No player found")
--     end
--     bO = false
-- end
...
--     local a4 = tOASIS.getPlayerPed()
--     local t = tOASIS.getPlayerCoords()
--     TriggerServerEvent("OASIS:spawnThrowBag",t,tOASIS.getNetId(bR, "spawnRope(entity)"),tOASIS.getNetId(a4, "spawnRope(ped)"))
--     Wait(2000)
--     tOASIS.notify("~g~Success~w~: Rope is now winding")
-- end
-- local bS = 100
-- RegisterNetEvent("OASIS:spawnThrowBag",function(t, aq, bT)
--     local a4 = tOASIS.getPlayerPed()
--     local bv = tOASIS.getPlayerCoords()
--     local V = #(bv - t)
--     if V < 30.0 then
--         RopeLoadTextures()
--         local bU = tOASIS.getObjectId(aq, "spawnThrowBag 1")
--         local bV = tOASIS.getObjectId(bT, "spawnThrowBag 2")
