RMenu.Add('PoliceDutyMenu', 'main', RageUI.CreateMenu("", "~b~Clock On", tARMA.getRageUIMenuWidth(), tARMA.getRageUIMenuHeight() ,'banners', 'clockon'))
...
RageUI.CreateWhile(1.0, true, function()
    if RageUI.Visible(RMenu:Get('PoliceDutyMenu', 'main')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            ...
            RageUI.Button("Assistant Commissioner" , nil, { RightLabel = "→" }, true, function(Hovered, Active, Selected)
                if Selected then
            ...
            RageUI.Button("Deputy Assistant Commissioner" , nil, { RightLabel = "→" }, true, function(Hovered, Active, Selected)
                if Selected then
            ...
            RageUI.Button("Commander" , nil, { RightLabel = "→" }, true, function(Hovered, Active, Selected)
                if Selected then
            ...
            RageUI.Button("Chief Superintendent" , nil, { RightLabel = "→" }, true, function(Hovered, Active, Selected)
                if Selected then
            ...
            RageUI.Button("Superintendent" , nil, { RightLabel = "→" }, true, function(Hovered, Active, Selected)
                if Selected then
            ...
            RageUI.Button("Chief Inspector" , nil, { RightLabel = "→" }, true, function(Hovered, Active, Selected)
                if Selected then
            ...
            RageUI.Button("Inspector" , nil, { RightLabel = "→" }, true, function(Hovered, Active, Selected)
                if Selected then
            ...
            RageUI.Button("Sergeant" , nil, { RightLabel = "→" }, true, function(Hovered, Active, Selected)
                if Selected then
            ...
            RageUI.Button("Special Police Constable" , nil, { RightLabel = "→" }, true, function(Hovered, Active, Selected)
                if Selected then
            ...
            RageUI.Button("Senior Police Constable" , nil, { RightLabel = "→" }, true, function(Hovered, Active, Selected)
                if Selected then
            ...
            RageUI.Button("Police Constable" , nil, { RightLabel = "→" }, true, function(Hovered, Active, Selected)
                if Selected then
            ...
            RageUI.Button("Police Community Support Officer" , nil, { RightLabel = "→" }, true, function(Hovered, Active, Selected)
                if Selected then
