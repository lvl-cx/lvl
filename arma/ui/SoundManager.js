const audio = [
    ...
    { name: "playCasinoWin", file: "casino_win.ogg", volume: 0.40 },
    { name: "playCasinoLose", file: "casino_lose.ogg", volume: 0.40 },
    ...
    { name: "askShowMeQuestion", file: "askShowMeQuestion.ogg", volume: 0.80},
    { name: "closeCall", file: "closeCall.ogg", volume: 0.80},
    { name: "completePaperwork", file: "completePaperwork.ogg", volume: 0.80},
    { name: "continueToFollow", file: "continueToFollow.ogg", volume: 0.80},
    { name: "controlledStop", file: "controlledStop.ogg", volume: 0.80},
    { name: "driveToTopFloor", file: "driveToTopFloor.ogg", volume: 0.80},
    { name: "emergencyStopIntroduction", file: "emergencyStopIntroduction.ogg", volume: 0.80},
    { name: "leavingMotorwayTurningRight", file: "leavingMotorwayTurningRight.ogg", volume: 0.80},
    { name: "minorFaults", file: "minorFaults.ogg", volume: 0.80},
    { name: "motorwayExplained", file: "motorwayExplained.ogg", volume: 0.80},
    { name: "moveOffWhenReady", file: "moveOffWhenReady.ogg", volume: 0.80},
    { name: "newDestinationSet", file: "newDestinationSet.ogg", volume: 0.80},
    { name: "nowReversePark", file: "nowReversePark.ogg", volume: 0.80},
    { name: "operateMainBeamHeadlights", file: "operateMainBeamHeadlights.ogg", volume: 0.80},
    { name: "policePursuitContinue", file: "policePursuitContinue.ogg", volume: 0.80},
    { name: "reverseParkComplete", file: "reverseParkComplete.ogg", volume: 0.80},
    { name: "seriousFaults", file: "seriousFaults.ogg", volume: 0.80},
    { name: "slowDownOrTermination", file: "slowDownOrTermination.ogg", volume: 0.80},
    { name: "stopNowMessage", file: "stopNowMessage.ogg", volume: 0.80},
    { name: "stopSign", file: "stopSign.ogg", volume: 0.80},
    { name: "testExplained", file: "testExplained.ogg", volume: 0.80},
    { name: "testFailed", file: "testFailed.ogg", volume: 0.80},
    { name: "testFailedGoodbye", file: "testFailedGoodbye.ogg", volume: 0.80},
    { name: "testPassed", file: "testPassed.ogg", volume: 0.80},
