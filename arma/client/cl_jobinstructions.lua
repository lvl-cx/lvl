...
function aaInstructions()
    ...
    initializeInstructionalJobScaleform(
        "Welcome to the AA",
        "I have set a waypoint to the AA garage where you can pickup your truck."
    )
...
function burgerShotInstructions()
    ...
    PlaySound(-1, "CHECKPOINT_BEHIND", "HUD_MINI_GAME_SOUNDSET", 0, 0, 1)
    initializeInstructionalJobScaleform(
        "Welcome to Burgershot",
        "I have set a waypoint to Burgershot where you can start your career."
    )
...
function royalMailInstructions()
    ...
    initializeInstructionalJobScaleform(
        "Royal Mail",
        "I have set a waypoint to the Royal Mail garage where you can start your shift."
    )
...
function G4SInstructions()
    ...
    initializeInstructionalJobScaleform(
        "G4S",
        "I have set a waypoint to the G4S depot where you'll start your first job."
    )
...
function lorryInstructions()
    ...
    SetNewWaypoint(862.86767578125, -3195.6655273438)
end
