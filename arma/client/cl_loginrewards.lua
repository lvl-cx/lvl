...
RMenu.Add("loginrewards","mainmenu",RageUI.CreateMenu("","Main Menu",tARMA.getRageUIMenuWidth(),tARMA.getRageUIMenuHeight(),"banners", "rewards"))
local b = 0
local c = 0
local function d(e)
...
RegisterNetEvent("ARMA:setDailyRewardInfo",function(w, x, y)
    b = w
