...
--[[ Citizen.CreateThread(function()
    if true then 
        ...
        tARMA.createArea("casino_garage",vector3(935.59118652344,0.42197805643082,77.7329765625),8,6,d,e,f)
...
Citizen.CreateThread(function()
    if true then 
        ...
        tARMA.createArea("casino_garage_exit",vector3(1363.3187255859,184.85275268555,-50.02239453125),10,6,d,e,f)
...
Citizen.CreateThread(function()
    if true then 
        ...
        tARMA.createArea("casino_office_exit",vector3(2638.2856445312,-328.36483764648,-65.743219726563),10,6,d,e,f)
    end 
end) ]]