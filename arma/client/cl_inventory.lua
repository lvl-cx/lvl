...
--     local m = 0
--     for n, o in pairs(ARMAPrimaryItems) do
--         m = m + o[3] * o[2]
--     end
--     return d - m
-- end
...
--     local m = 0
--     for n, o in pairs(ARMASecondItems) do
--         m = m + o[3] * o[2]
--     end
--     return e - m
-- end
...
--     d = q
-- end)
-- RegisterNetEvent("ARMA:getSecondInventoryData",function(p, q, r)
--     ARMASecondItems = p
--     e = q
--     c = true
...
--     local s = tARMA.getNearestVehicle(6)
--     if s then
--         local t = GetEntityModel(s)
--         local u = nil
--         for v, w in pairs(globalVehicleModelHashMapping) do
--             if v == t then
--                 u = w
--             end
--         end
--         if u then
--             local x, y = tARMA.getVehicleInfos(s)
--             if x == tARMA.getUserId() and y == u then
--                 c = true
--                 drawInventoryUI = true
--                 setCursor(1)
--                 f = s
--                 print("[ARMA Trunks] calling OpenVehicleTrunk: " .. tostring(globalVehicleModelHashMapping[t]))
--                 --ARMAserver.OpenVehicleTrunk({globalVehicleModelHashMapping[t]})
...
--         end
--     else
--         tARMA.notify("~r~No vehicle nearby")
--     end
-- end)
-- Citizen.CreateThread(function()
--     while true do
...
--                 local E = 0
--                 local F = 0
--                 local G = sortAlphabetically(ARMASecondItems)
...
--             if F / d > 0.5 then
--                 if F / d > 0.9 then
--                     DrawAdvancedText(0.516,0.307,0.005,0.0028,0.366,"Weight: " .. F .. "/" .. d .. "kg",255,50,0,255,4,0)
--                 else
--                     DrawAdvancedText(0.516,0.307,0.005,0.0028,0.366,"Weight: " .. F .. "/" .. d .. "kg",255,165,0,255,4,0)
--                 end
--             else
--                 DrawAdvancedText(0.516,0.307,0.005,0.0028,0.366,"Weight: " .. F .. "/" .. d .. "kg",255,255,255,255,4,0)
--             end
--         end
--         Wait(0)
--     end
