...
cfg.Buttons = {
    ...
    TriggerServerEvent('ARMAAdmin:Ban', self, hours, reason)
    end, "player.ban"},
    ["Kick"] = {function(self)
    ...
    if (GetOnscreenKeyboardResult()) then
        ...
        if result then 
            result = result
            TriggerServerEvent('ARMAAdmin:Kick', self, result, false)
        end
    end
    end, "player.kick"},
    ["No Warning Kick"] = {function(self)
        ...
        if (GetOnscreenKeyboardResult()) then
            ...
            if result then 
                result = result
                TriggerServerEvent('ARMAAdmin:Kick', self, result, true)
            end
        end
    end, "player.kick"},
    ["Revive"] = {function(self)
        TriggerServerEvent('ARMAAdmin:Revive', self)
    end, "player.revive"},
    ["Slap"] = {function(self)
        TriggerServerEvent('ARMAAdmin:SlapPlayer', self)
    end, "player.slap"},
    ["Spectate"] = {function(self)
        TriggerServerEvent('ARMAAdmin:SpectatePlr', self)
    end, "player.spectate"},
    ...
    ["Add Car"] = {function(self)
        ...
        if (GetOnscreenKeyboardResult()) then
            local result = GetOnscreenKeyboardResult()
            if result then 
                TriggerServerEvent('ARMAAdmin:AddCar', self, result)
            end
        end
    end, "player.addcar"},
    ["TP To Player"] = {function(self)
        TriggerServerEvent('ARMAAdmin:TPTo', self)
    end, "player.tpto"},
    ["Bring Player"] = {function(self)
        TriggerServerEvent('ARMAAdmin:Bring', self)
    end, "player.tpbring"},
    ["Add Group"] = {function(self)
        ...
        if (GetOnscreenKeyboardResult()) then
            local result = GetOnscreenKeyboardResult()
            if result then 
                TriggerServerEvent('ARMAAdmin:AddGroup', self, result)
            end
        end
    ...
    ["Warn Player"] = {function(self)
        ...
        if userWarningMessage then
            TriggerServerEvent("arma:warnPlayer",self,userWarningMessage)
        else
            tARMA.notify('Please enter a warning message!')
        end
    end, "player.kick"},
...
cfg.MiscButtons = {
    ["Entity Cleanup"] = {function(self)
        TriggerServerEvent('ARMAAdmin:PropCleanup')
    ...
    ["Entity Cleanup Gun"] = {function(self)
        TriggerServerEvent('ARMAAdmin:EntityCleanupGun')
    ...
    ["Shutdown Server"] = {function(self)
        TriggerServerEvent('ARMAAdmin:ServerShutdown')
