...
cfg.announces = {
  ["admin"] = {
    --image = "nui://arma_mod/announce_admin.png",
  ...
  ["police"] = {
    --image = "nui://arma_mod/announce_police.png",
  ...
  ["commercial"] = {
    --image = "nui://arma_mod/announce_commercial.png",
    image = "http://i.imgur.com/b2O9WMa.png",
    description = "Commercial stuff (buy, sell, work).",
    price = 5000
  },
  ["party"] = {
    --image = "nui://arma_mod/announce_party.png",
