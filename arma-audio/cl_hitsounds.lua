...
RegisterCommand("hs", function()
    ...
    if playHeadshotSounds then
        ARMANotify("~y~Experimental Hitmarkers Are Now ~g~Enabled")
    else
        ARMANotify("~y~Experimental Hitmarkers Are Now ~r~Disabled")
    end
end)



RegisterNetEvent("ARMA:Settings:Hitsounds")
AddEventHandler("ARMA:Settings:Hitsounds", function(bool)
...
RegisterNetEvent("ARMA:ComingSoon")
AddEventHandler("ARMA:ComingSoon", function()
    ARMANotify("~r~Error: ~w~This Feature Is Coming Soon")
end)

RegisterNetEvent("ARMACli:Notify")
AddEventHandler("ARMACli:Notify", function(txt)
    ARMANotify(txt)
end)
