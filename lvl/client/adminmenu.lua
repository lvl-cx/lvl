...
RMenu.Add('adminmenu', 'main', RageUI.CreateMenu("", "~b~LVL Admin Menu", 1300, 50, 'admin', 'admin'))
...
RMenu.Add("adminmenu", "settings", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "main"),"","~b~LVL Admin Menu", 1300, 50,"admin","admin"))
...
RageUI.CreateWhile(1.0, true, function()
    if RageUI.Visible(RMenu:Get('adminmenu', 'main')) then
        ...
        if admincfg.buttonsEnabled["adminMenu"][1] and buttons["adminMenu"] then
            RageUI.Button("All Players", nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
            end, RMenu:Get('adminmenu', 'players'))
        end

        if admincfg.buttonsEnabled["adminMenu"][1] and buttons["adminMenu"] then
            RageUI.Button("Search Functions", nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
            end, RMenu:Get('adminmenu', 'searchoptions'))
        end

        if admincfg.buttonsEnabled["adminMenu"][1] and buttons["adminMenu"] then
            RageUI.Button("Functions", nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
            end, RMenu:Get('adminmenu', 'functions'))
        end

        if admincfg.buttonsEnabled["adminMenu"][1] and buttons["adminMenu"] then
            RageUI.Button("Settings", nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
...
RageUI.CreateWhile(1.0, true, function()
    if RageUI.Visible(RMenu:Get('adminmenu', 'players')) then
        ...
        for k,v in pairs(players) do
            RageUI.Button("[" .. v[3] .. "] " .. v[1], nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
                if Selected then
...
RMenu.Add('SettingsMenu', 'MainMenu', RageUI.CreateMenu("", "~b~LVL Settings Menu", 1300, 50,"settings","settings")) 
...
RageUI.CreateWhile(1.0, true, function()
    if RageUI.Visible(RMenu:Get('adminmenu', 'searchoptions')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
        foundMatch = false
        RageUI.Button("Search by Name", nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
        end, RMenu:Get('adminmenu', 'searchname'))
        
        RageUI.Button("Search by Perm ID", nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
        end, RMenu:Get('adminmenu', 'searchpermid'))

        RageUI.Button("Search by Temp ID", nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
...
RageUI.CreateWhile(1.0, true, function()
    if RageUI.Visible(RMenu:Get('adminmenu', 'functions')) then
        ...
        RageUI.Button("General Functions", nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
        end, RMenu:Get('adminmenu', 'generalfunctions'))
        if admincfg.buttonsEnabled["devMenu"][1] and buttons["devMenu"] then
            RageUI.Button("Entity Functions", nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
            end, RMenu:Get('adminmenu', 'entityfunctions'))
        end

        if admincfg.buttonsEnabled["vehFunctions"][1] and buttons["vehFunctions"] then
            RageUI.Button("Vehicle Functions", nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
            end, RMenu:Get('adminmenu', 'vehiclefunctions'))
        end

        if admincfg.buttonsEnabled["devMenu"][1] and buttons["devMenu"] then
            RageUI.Button("Developer Functions", nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
    ...
    if RageUI.Visible(RMenu:Get('adminmenu', 'generalfunctions')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            ...
            if admincfg.buttonsEnabled["tp2waypoint"][1] and buttons["tp2waypoint"] then
                RageUI.Button("Teleport to Waypoint", nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
            ...
            if admincfg.buttonsEnabled["spawnBmx"][1] and buttons["spawnBmx"] then
                RageUI.Button("Spawn BMX", nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        SpawnVehicle('bmx')
                    end
                end, RMenu:Get('adminmenu', 'generalfunctions'))
            ...
            if admincfg.buttonsEnabled["noClip"][1] and buttons["noClip"] then
                RageUI.Button("Noclip Toggle",nil,{RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
            ...
            if admincfg.buttonsEnabled["removewarn"][1] and buttons["removewarn"] then
                RageUI.Button("Remove Warning", nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
            ...
            if admincfg.buttonsEnabled["ban"][1] and buttons["ban"] then
                RageUI.Button("Unban Player",nil,{RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
            ...
            if admincfg.buttonsEnabled["ban"][1] and buttons["ban"] then
                RageUI.Button("Offline Ban",nil,{RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        local uid = GetPlayerServerId(PlayerId())
                        local permid = getPermId()
...
RageUI.CreateWhile(1.0, true, function()
    if RageUI.Visible(RMenu:Get('adminmenu', 'entityfunctions')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            ...
            if admincfg.buttonsEnabled["devMenu"][1] and buttons["devMenu"] then
                RageUI.Button("Entity Cleanup", nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
            ...
            if admincfg.buttonsEnabled["devMenu"][1] and buttons["devMenu"] then
                RageUI.Button("Deattach Entity Cleanup", nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
            ...
            if admincfg.buttonsEnabled["devMenu"][1] and buttons["devMenu"] then
                RageUI.Button("Vehicle Cleanup", nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
            ...
            if admincfg.buttonsEnabled["devMenu"][1] and buttons["devMenu"] then
                RageUI.Button("Ped Cleanup", nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
            ...
            if admincfg.buttonsEnabled["devMenu"][1] and buttons["devMenu"] then
                RageUI.Button("All Cleanup", nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
...
RageUI.CreateWhile(1.0, true, function()
    if RageUI.Visible(RMenu:Get('adminmenu', 'vehiclefunctions')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            ...
            if admincfg.buttonsEnabled["vehFunctions"][1] and buttons["vehFunctions"] then
                RageUI.Button("Fix Vehicle", nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        ...
                        if IsPedInAnyVehicle(playerPed, false) then
                            ...
                            tLVL.notify("~b~Your vehicle has been fixed!")
                        else
            ...
            if admincfg.buttonsEnabled["vehFunctions"][1] and buttons["vehFunctions"] then
                RageUI.Button("Clean Vehicle", nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        local playerPed = GetPlayerPed(-1)
                        if IsPedInAnyVehicle(playerPed, false) then
                            local vehicle = GetVehiclePedIsIn(playerPed, false)
                            SetVehicleDirtLevel(vehicle, 0)
                            tLVL.notify("~b~Your vehicle has been cleaned!")
                        else
    ...
    if RageUI.Visible(RMenu:Get('adminmenu', 'devfunctions')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            ...
            if admincfg.buttonsEnabled["spawnGun"][1] and buttons["spawnGun"] then
                RageUI.Button("Spawn Weapon", nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                            ...
                            if result then 
                              --  LVLclient.allowWeapon(result, "-1")
                                ...
                                if GetSelectedPedWeapon(PlayerPedId()) == GetHashKey(result) then 
                                    notify("~b~Successfuly spawned in weapon!")
                                else
            ...
            if admincfg.buttonsEnabled["devMenu"][1] and buttons["devMenu"] then
                RageUI.Button("Get Coords", nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
            ...
            if admincfg.buttonsEnabled["devMenu"][1] and buttons["devMenu"] then
                RageUI.Button("Teleport to Coords",nil,{RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                    ...
                    if SearchName == nil then 
                        ...
                        for k, v in pairs(players) do
                            ...
                            if string.match(v[1],SearchName) then
                                RageUI.Button("[" .. v[2] .. "] " .. v[1], nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
                                    if Selected then
        ...
        RageUI.CreateWhile(1.0, true, function()
            if RageUI.Visible(RMenu:Get('adminmenu', 'submenu')) then
                RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
                        ...
                        RageUI.Button("Teleport Player", nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)end, RMenu:Get('adminmenu', 'teleportmenu'))
                 
                        RageUI.Button("Control Player", nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)end, RMenu:Get('adminmenu', 'control'))
                
                        RageUI.Button("Manage Player", nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)end, RMenu:Get('adminmenu', 'manage'))
                   
                        RageUI.Button("Punish Player", nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)end, RMenu:Get('adminmenu', 'punishment'))
            ...
            if RageUI.Visible(RMenu:Get('adminmenu', 'control')) then
                RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
                    ...
                    if admincfg.buttonsEnabled["FREEZE"][1] and buttons["FREEZE"] then
                        RageUI.Button("Freeze Player", nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
                            if Selected then
                                local uid = GetPlayerServerId(PlayerId())
                    ...
                    if admincfg.buttonsEnabled["slap"][1] and buttons["slap"] then
                        RageUI.Button("Slap Player", nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
                            if Selected then
                                local uid = GetPlayerServerId(PlayerId())
                    ...
                    if admincfg.buttonsEnabled["revive"][1] and buttons["revive"] then
                        RageUI.Button("Revive Player", nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
                            if Selected then
                                local uid = GetPlayerServerId(PlayerId())
                    ...
                    if admincfg.buttonsEnabled["spectate"][1] and buttons["spectate"] then
                        RageUI.Button("Spectate Player", nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
                            if Selected then
            ...
            if RageUI.Visible(RMenu:Get('adminmenu', 'manage')) then
                RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
                    ...
                    if admincfg.buttonsEnabled["addcar"][1] and buttons["addcar"] then
                        RageUI.Button("Add Import Car", nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
                            if Selected then
                    ...
                    if admincfg.buttonsEnabled["getgroups"][1] and buttons["getgroups"] then
                        RageUI.Button("Get Groups",nil,{RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
                            if Selected then
                    ...
                    if admincfg.buttonsEnabled["showwarn"][1] and buttons["showwarn"] then
                        RageUI.Button("Show Player Warnings", nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
                            if Selected then
        ...
        RageUI.CreateWhile(1.0, true, function()
            if RageUI.Visible(RMenu:Get('adminmenu', 'punishment')) then
                RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
                    ...
                    if admincfg.buttonsEnabled["ban"][1] and buttons["ban"] then
                            RageUI.Button("Ban Player", nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
                                if Selected then
                    ...
                    if admincfg.buttonsEnabled["kick"][1] and buttons["kick"] then
                        RageUI.Button("Kick Player", nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
                            if Selected then
                    ...
                    if admincfg.buttonsEnabled["nof10kick"][1] and buttons["nof10kick"] then
                        RageUI.Button("No F10 Kick", nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
                            if Selected then
                                local kickReason = KeyboardInput("Reason:", "", 100)
                                local uid = GetPlayerServerId(PlayerId())
                    ...
                    if admincfg.buttonsEnabled["warn"][1] and buttons["warn"] then
                        RageUI.Button("Warn Player", nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
                            if Selected then
        ...
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            ...
            if admincfg.buttonsEnabled["warn"][1] and buttons["warn"] then
                for i , p in pairs(warningbankick) do 
                    RageUI.Button("Warn Player for "..p.name, nil, { RightLabel = "~b~→" }, true, function(Hovered, Active, Selected)
                        if Selected then
                        
                            TriggerServerEvent("lvl:warnPlayer",SelectedPlayer[3],p.name)
                            notify(SelectedPlayer[3])
                            notify("~b~Warned Player for "..p.name)
                        end
                    end, RMenu:Get('adminmenu', 'submenu'))
                 end
            end
...
RageUI.CreateWhile(1.0, true, function()
    if RageUI.Visible(RMenu:Get('adminmenu', 'bansub')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            ...
            if admincfg.buttonsEnabled["ban"][1] and buttons["ban"] then
                RageUI.Button("[Custom Ban Message]", nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
    ...
    if RageUI.Visible(RMenu:Get('adminmenu', 'teleportmenu')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            if admincfg.buttonsEnabled["TP2"][1] and buttons["TP2"] then
                RageUI.Button("Teleport to Player", nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        local newSource = GetPlayerServerId(PlayerId())
                        TriggerServerEvent('LVL:TeleportToPlayer', newSource, SelectedPlayer[2])
                        notify('~b~Teleported to player.')
                    end
                end, RMenu:Get('adminmenu', 'teleportmenu'))
            end

            if admincfg.buttonsEnabled["TPLoc"][1] and buttons["TPLoc"] then
                RageUI.Button("Teleport Player To Me", nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent('LVLAdmin:Bring', SelectedPlayer[3])
                        notify('~b~Teleported player to you.')
                    end
                end, RMenu:Get('adminmenu', 'teleportmenu'))
            end

            if admincfg.buttonsEnabled["TP2ME"][1] and buttons["TP2ME"] then
                RageUI.Button("Teleport Player To Admin Island", nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent("LVL:Teleport2AdminIsland", SelectedPlayer[2])
                        notify('~b~Teleported player to Admin Island.')
                    end
                end, RMenu:Get('adminmenu', 'teleportmenu'))
            end

            if admincfg.buttonsEnabled["TP2ME"][1] and buttons["TP2ME"] then
                RageUI.Button("Return Player to Previous Location", nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent("LVL:returnplayer", SelectedPlayer[2])
                        notify('~b~Returned Player.')
                    end
                end, RMenu:Get('adminmenu', 'teleportmenu'))
            end
                ...
                if admincfg.buttonsEnabled["TPLoc"][1] and buttons["TPLoc"] then -- TPLoc
                    RageUI.Button("Teleport Player Legion Bank", nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
                        if Selected then
                            TriggerServerEvent("LVL:Teleport", SelectedPlayer[2], vector3(151.61740112305,-1035.05078125,29.339416503906))
                            notify('~b~Teleported player to location.')
                        end
                    end, RMenu:Get('adminmenu', 'teleportmenu'))
                end

                if admincfg.buttonsEnabled["TPLoc"][1] and buttons["TPLoc"] then
                    RageUI.Button("Teleport Player To City License Centre", nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
                        if Selected then
                ...
                if admincfg.buttonsEnabled["TPLoc"][1] and buttons["TPLoc"] then
                    RageUI.Button("Teleport Player To Sandy License Centre", nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
                        if Selected then
                ...
                if admincfg.buttonsEnabled["TPLoc"][1] and buttons["TPLoc"] then
                    RageUI.Button("Teleport Player Rebel Diner", nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
                        if Selected then
    ...
    if RageUI.Visible(RMenu:Get('adminmenu', 'groups')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            if admincfg.buttonsEnabled["staffGroups"][1] and buttons["staffGroups"] then
                RageUI.Button("Staff Groups", nil, { RightLabel = "~b~→" }, true, function(Hovered, Active, Selected)
                    if (Hovered) then
            ...
            if admincfg.buttonsEnabled["licenseGroups"][1] and buttons["licenseGroups"] then
                RageUI.Button("License Groups", nil, { RightLabel = "~b~→" }, true, function(Hovered, Active, Selected)
                    if (Hovered) then
            ...
            if admincfg.buttonsEnabled["povGroups"][1] and buttons["povGroups"] then
                RageUI.Button("POV Groups", nil, { RightLabel = "~b~→" }, true, function(Hovered, Active, Selected)
                    if (Hovered) then
            ...
            if admincfg.buttonsEnabled["mpdGroups"][1] and buttons["mpdGroups"] then
                RageUI.Button("Police Groups", nil, { RightLabel = "~b~→" }, true, function(Hovered, Active, Selected)
                    if (Hovered) then
            ...
            if admincfg.buttonsEnabled["nhsGroups"][1] and buttons["nhsGroups"] then
                RageUI.Button("NHS Groups", nil, { RightLabel = "~b~→" }, true, function(Hovered, Active, Selected)
                    if (Hovered) then
            ...
            if admincfg.buttonsEnabled["donoGroups"][1] and buttons["donoGroups"] then
                RageUI.Button("Donator Groups", nil, { RightLabel = "~b~→" }, true, function(Hovered, Active, Selected)
                    if (Hovered) then
        ...
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            for k,v in pairs(getStaffGroupsGroupIds) do
                if searchPlayerGroups[k] ~= nil then
                    RageUI.Button("~b~"..v, nil, { RightLabel = "~b~→" }, true, function(Hovered, Active, Selected)
                        if (Selected) then
                    ...
                    RageUI.Button("~r~"..v, nil, { RightLabel = "~b~→" }, true, function(Hovered, Active, Selected)
                        if (Selected) then
...
RageUI.CreateWhile(1.0, true, function()
    if RageUI.Visible(RMenu:Get('adminmenu', 'addgroup')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            ...
            RageUI.Button("Add this group to user", nil, { RightLabel = "~b~→" }, true, function(Hovered, Active, Selected)
                if (Selected) then
...
RageUI.CreateWhile(1.0, true, function()
    if RageUI.Visible(RMenu:Get('adminmenu', 'removegroup')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            ...
            RageUI.Button("Remove user from group", "", { RightLabel = "~b~→" }, true, function(Hovered, Active, Selected)
                if (Selected) then
...
Citizen.CreateThread(function()
    while (true) do
        ...
        if InSpectatorMode then
            ...
            Draw2DText(0.22, 0.90, 'Health: ~b~' .. GetEntityHealth(targetPed) .. " / " .. GetEntityMaxHealth(targetPed), 0.65) 
...
AddEventHandler('LVLAdmin:Spectate', function(plr,tpcoords)
    ...
    if not Spectating then
        ...
        tLVL.notify('~b~Spectating Player.')
    else 
