...
RMenu.Add('adminmenu', 'main', RageUI.CreateMenu("", "~w~LVL Admin Menu", 1300, 50, 'admin', 'admin'))
...
RMenu.Add("adminmenu", "settings", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "main"),"","~w~LVL Admin Menu", 1300, 50,"admin","admin"))
...
RegisterNetEvent('LVL:ReturnPOV')
AddEventHandler('LVL:ReturnPOV', function(pov)
    povlist = pov
end)
...
RageUI.CreateWhile(1.0, true, function()
    if RageUI.Visible(RMenu:Get('adminmenu', 'main')) then
        ...
        if admincfg.buttonsEnabled["adminMenu"][1] and buttons["adminMenu"] then
            RageUI.Button("All Players", nil, {RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)
            end, RMenu:Get('adminmenu', 'players'))
        end

        if admincfg.buttonsEnabled["adminMenu"][1] and buttons["adminMenu"] then
            RageUI.Button("Search Functions", nil, {RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)
            end, RMenu:Get('adminmenu', 'searchoptions'))
        end

        if admincfg.buttonsEnabled["adminMenu"][1] and buttons["adminMenu"] then
            RageUI.Button("Functions", nil, {RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)
            end, RMenu:Get('adminmenu', 'functions'))
        end

        if admincfg.buttonsEnabled["adminMenu"][1] and buttons["adminMenu"] then
            RageUI.Button("Settings", nil, {RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)
...
RageUI.CreateWhile(1.0, true, function()
    if RageUI.Visible(RMenu:Get('adminmenu', 'players')) then
        ...
        for k,v in pairs(players) do
            RageUI.Button("[" .. v[3] .. "] " .. v[1], nil, {RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)
                if Selected then
                    SelectedPlayer = players[k]
                    SelectedPerm = v[3]
                    TriggerServerEvent("LVL:CheckPOV",v[3])
                end
...
RMenu.Add('SettingsMenu', 'MainMenu', RageUI.CreateMenu("", "~w~LVL Settings Menu", 1300, 50,"settings","settings")) 
            ...
            RageUI.Checkbox("Rust Hitsounds",nil, HitmarkerSounds, {Style = RageUI.CheckboxStyle.Car}, function(Hovered, Active, Selected, Checked)
                if Selected then 
                    if not HitmarkerSounds then
                        TriggerEvent("LVL:Settings:Hitsounds", true)
                        HitmarkerSounds = true
                    else
                        TriggerEvent("LVL:Settings:Hitsounds", false)
...
Citizen.CreateThread(function()
    while true do
        while streetnames do
            ...
            drawTxt2(UI.Left_x + 0.003 , UI.Bottom_y - 0.227 , 0.4, "~w~"..Zone.." / ~w~"..GetStreetNameFromHashKey(rua), 255, 255, 255, 255, 0) -- Street
            Citizen.Wait(1)
        end
        Citizen.Wait(1)
    end
...
RegisterNetEvent('LVL:OpenSettingsMenu')
AddEventHandler('LVL:OpenSettingsMenu', function(admin)
    if not admin then
...
RegisterCommand('opensettingsmenu',function()
    TriggerServerEvent('LVL:OpenSettings')
end)
...
RageUI.CreateWhile(1.0, true, function()
    if RageUI.Visible(RMenu:Get('adminmenu', 'searchoptions')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
        foundMatch = false
        RageUI.Button("Search by Name", nil, {RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)
        end, RMenu:Get('adminmenu', 'searchname'))
        
        RageUI.Button("Search by Perm ID", nil, {RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)
        end, RMenu:Get('adminmenu', 'searchpermid'))

        RageUI.Button("Search by Temp ID", nil, {RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)
...
RageUI.CreateWhile(1.0, true, function()
    if RageUI.Visible(RMenu:Get('adminmenu', 'functions')) then
        ...
        RageUI.Button("General Functions", nil, {RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)
        end, RMenu:Get('adminmenu', 'generalfunctions'))
        if admincfg.buttonsEnabled["devMenu"][1] and buttons["devMenu"] then
            RageUI.Button("Entity Functions", nil, {RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)
            end, RMenu:Get('adminmenu', 'entityfunctions'))
        end

        if admincfg.buttonsEnabled["vehFunctions"][1] and buttons["vehFunctions"] then
            RageUI.Button("Vehicle Functions", nil, {RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)
            end, RMenu:Get('adminmenu', 'vehiclefunctions'))
        end

        if admincfg.buttonsEnabled["devMenu"][1] and buttons["devMenu"] then
            RageUI.Button("Developer Functions", nil, {RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)
    ...
    if RageUI.Visible(RMenu:Get('adminmenu', 'generalfunctions')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            ...
            if admincfg.buttonsEnabled["tp2waypoint"][1] and buttons["tp2waypoint"] then
                RageUI.Button("Teleport to Waypoint", nil, {RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
            ...
            if admincfg.buttonsEnabled["spawnBmx"][1] and buttons["spawnBmx"] then
                RageUI.Button("Spawn BMX", nil, {RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        SpawnVehicle('bmx')
                    end
                end, RMenu:Get('adminmenu', 'generalfunctions'))
            ...
            if admincfg.buttonsEnabled["noClip"][1] and buttons["noClip"] then
                RageUI.Button("Noclip Toggle",nil,{RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
            ...
            if admincfg.buttonsEnabled["removewarn"][1] and buttons["removewarn"] then
                RageUI.Button("Remove Warning", nil, {RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        ...
                        if (GetOnscreenKeyboardResult()) then
                            ...
                            if result then 
                                TriggerServerEvent('LVL:RemoveWarning', uid, result)
                            end
                        end
                    end
                end, RMenu:Get('adminmenu', 'generalfunctions'))
            ...
            if admincfg.buttonsEnabled["ban"][1] and buttons["ban"] then
                RageUI.Button("Unban Player",nil,{RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        local permid = getPermId()
                        TriggerServerEvent("LVL:Unban", permid)
                    end
                end)
            end

            if admincfg.buttonsEnabled["ban"][1] and buttons["ban"] then
                RageUI.Button("Offline Ban",nil,{RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        local uid = GetPlayerServerId(PlayerId())
                        local permid = getPermId()
                        local banReason = KeyboardInput("Reason:", "", 100)
                        local banTime = KeyboardInput("Hours:", "", 20)
                        TriggerServerEvent('LVL:BanPlayer', uid, permid, banReason, tonumber(banTime))
                    end
                end)
            end
        end)
...
RageUI.CreateWhile(1.0, true, function()
    if RageUI.Visible(RMenu:Get('adminmenu', 'entityfunctions')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            ...
            if admincfg.buttonsEnabled["devMenu"][1] and buttons["devMenu"] then
                RageUI.Button("Entity Cleanup", nil, {RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent('LVL:PropCleanup')
                    end
                end, RMenu:Get('adminmenu', 'entityfunctions'))
            end

            if admincfg.buttonsEnabled["devMenu"][1] and buttons["devMenu"] then
                RageUI.Button("Deattach Entity Cleanup", nil, {RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent('LVL:DeAttachEntity')
                    end
                end, RMenu:Get('adminmenu', 'entityfunctions'))
            end

            if admincfg.buttonsEnabled["devMenu"][1] and buttons["devMenu"] then
                RageUI.Button("Vehicle Cleanup", nil, {RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent('LVL:VehCleanup')
                    end
                end, RMenu:Get('adminmenu', 'entityfunctions'))
            end

            if admincfg.buttonsEnabled["devMenu"][1] and buttons["devMenu"] then
                RageUI.Button("Ped Cleanup", nil, {RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent('LVL:PedCleanup')
                    end
                end, RMenu:Get('adminmenu', 'entityfunctions'))
            end

            if admincfg.buttonsEnabled["devMenu"][1] and buttons["devMenu"] then
                RageUI.Button("All Cleanup", nil, {RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent('LVL:CleanAll')
                    end
                end, RMenu:Get('adminmenu', 'entityfunctions'))
            end
...
RageUI.CreateWhile(1.0, true, function()
    if RageUI.Visible(RMenu:Get('adminmenu', 'vehiclefunctions')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            ...
            if admincfg.buttonsEnabled["vehFunctions"][1] and buttons["vehFunctions"] then
                RageUI.Button("Spawn Vehicle", nil, {RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
            ...
            if admincfg.buttonsEnabled["vehFunctions"][1] and buttons["vehFunctions"] then
                RageUI.Button("Fix Vehicle", nil, {RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        ...
                        if IsPedInAnyVehicle(playerPed, false) then
                            ...
                            tLVL.notify("~w~Your vehicle has been fixed!")
                        else
                            tLVL.notify("~o~You're not in a vehicle! There is no vehicle to fix!")
                        end
                    end
                end, RMenu:Get('adminmenu', 'vehiclefunctions'))
            end
            ...
            if admincfg.buttonsEnabled["vehFunctions"][1] and buttons["vehFunctions"] then
                RageUI.Button("Clean Vehicle", nil, {RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        local playerPed = GetPlayerPed(-1)
                        if IsPedInAnyVehicle(playerPed, false) then
                            local vehicle = GetVehiclePedIsIn(playerPed, false)
                            SetVehicleDirtLevel(vehicle, 0)
                            tLVL.notify("~w~Your vehicle has been cleaned!")
                        else
                            tLVL.notify("~o~You're not in a vehicle! There is no vehicle to clean!")
                        end
                    end
                end, RMenu:Get('adminmenu', 'vehiclefunctions'))
            end
    ...
    if RageUI.Visible(RMenu:Get('adminmenu', 'devfunctions')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            ...
            if admincfg.buttonsEnabled["spawnGun"][1] and buttons["spawnGun"] then
                RageUI.Button("Spawn Weapon", nil, {RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
            ...
            if admincfg.buttonsEnabled["devMenu"][1] and buttons["devMenu"] then
                RageUI.Button("Get Coords", nil, {RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent('LVLDEV:GetCoords')
                    end
                end, RMenu:Get('adminmenu', 'devfunctions'))
            end

            if admincfg.buttonsEnabled["devMenu"][1] and buttons["devMenu"] then
                RageUI.Button("Teleport to Coords",nil,{RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent("LVL:Tp2Coords")
                    end
                end, RMenu:Get('adminmenu', 'devfunctions'))
            end
                    ...
                    if SearchName == nil then 
                        ...
                        for k, v in pairs(players) do
                            ...
                            if string.match(v[1],SearchName) then
                                RageUI.Button("[" .. v[2] .. "] " .. v[1], nil, {RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)
                                    if Selected then
        ...
        RageUI.CreateWhile(1.0, true, function()
            if RageUI.Visible(RMenu:Get('adminmenu', 'submenu')) then
                RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
                        ...
                        RageUI.Button("Teleport Player", nil, {RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)end, RMenu:Get('adminmenu', 'teleportmenu'))
                 
                        RageUI.Button("Control Player", nil, {RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)end, RMenu:Get('adminmenu', 'control'))
                
                        RageUI.Button("Manage Player", nil, {RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)end, RMenu:Get('adminmenu', 'manage'))
                   
                        RageUI.Button("Punish Player", nil, {RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)end, RMenu:Get('adminmenu', 'punishment'))
            ...
            if RageUI.Visible(RMenu:Get('adminmenu', 'control')) then
                RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
                    ...
                    if admincfg.buttonsEnabled["FREEZE"][1] and buttons["FREEZE"] then
                        RageUI.Button("Freeze Player", nil, {RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)
                            if Selected then
                                local uid = GetPlayerServerId(PlayerId())
                                isFrozen = not isFrozen
                                TriggerServerEvent('LVL:FreezeSV', uid, SelectedPlayer[2], isFrozen)
                            end
                        end)
                    end
    
                    if admincfg.buttonsEnabled["slap"][1] and buttons["slap"] then
                        RageUI.Button("Slap Player", nil, {RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)
                            if Selected then
                                local uid = GetPlayerServerId(PlayerId())
                                TriggerServerEvent('LVL:SlapPlayer', uid, SelectedPlayer[2])
                            end
                        end)
                    end
                    ...
                    if admincfg.buttonsEnabled["revive"][1] and buttons["revive"] then
                        RageUI.Button("Revive Player", nil, {RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)
                            if Selected then
                                local uid = GetPlayerServerId(PlayerId())
                                TriggerServerEvent('LVL:RevivePlayer', uid, SelectedPlayer[2])
                            end
                        end)
                    end
                    ...
                    if admincfg.buttonsEnabled["spectate"][1] and buttons["spectate"] then
                        RageUI.Button("Spectate Player", nil, {RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)
                            if Selected then
                                --SetEntityCoords(PlayerPedId(), GetEntityCoords(SelectedPlayer[2]))
                                TriggerServerEvent('LVLAdmin:SpectatePlr', SelectedPlayer[3])
                            end
                        end)
                    end
            ...
            if RageUI.Visible(RMenu:Get('adminmenu', 'manage')) then
                RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
                    ...
                    if admincfg.buttonsEnabled["addcar"][1] and buttons["addcar"] then
                        RageUI.Button("Add Import Car", nil, {RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)
                            if Selected then
                                ...
                                if (GetOnscreenKeyboardResult()) then
                                    local result = GetOnscreenKeyboardResult()
                                    if result then 
                                        TriggerServerEvent('LVL:AddCar', SelectedPlayer[3], result)
                                    end
                                end
                            end
                        end, RMenu:Get('adminmenu', 'submenu'))
                    ...
                    if admincfg.buttonsEnabled["getgroups"][1] and buttons["getgroups"] then
                        RageUI.Button("Get Groups",nil,{RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)
                            if Selected then
                                TriggerServerEvent("LVL:getGroups", SelectedPlayer[2], SelectedPlayer[3])
                            end
                        end,RMenu:Get("adminmenu", "groups"))
                    end
                    
                    if admincfg.buttonsEnabled["showwarn"][1] and buttons["showwarn"] then
                        RageUI.Button("Show Player Warnings", nil, {RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)
                            if Selected then
        ...
        RageUI.CreateWhile(1.0, true, function()
            if RageUI.Visible(RMenu:Get('adminmenu', 'punishment')) then
                RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
                    ...
                    if admincfg.buttonsEnabled["ban"][1] and buttons["ban"] then
                            RageUI.Button("Ban Player", nil, {RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)
                                if Selected then
                    ...
                    if admincfg.buttonsEnabled["kick"][1] and buttons["kick"] then
                        RageUI.Button("Kick Player", nil, {RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)
                            if Selected then
                                local kickReason = KeyboardInput("Reason:", "", 100)
                                local uid = GetPlayerServerId(PlayerId())
                                TriggerServerEvent('LVL:KickPlayer', uid, SelectedPlayer[3], kickReason, SelectedPlayer[2])
                            end
                        end)
                    end
    
                    if admincfg.buttonsEnabled["nof10kick"][1] and buttons["nof10kick"] then
                        RageUI.Button("No F10 Kick", nil, {RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)
                            if Selected then
                                local kickReason = KeyboardInput("Reason:", "", 100)
                                local uid = GetPlayerServerId(PlayerId())
                                TriggerServerEvent('LVL:KickPlayerNoF10', uid, SelectedPlayer[3], kickReason)
                            end
                        end)
                    end
    
                    if admincfg.buttonsEnabled["warn"][1] and buttons["warn"] then
                        RageUI.Button("Warn Player", nil, {RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)
                            if Selected then
        ...
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            ...
            if admincfg.buttonsEnabled["warn"][1] and buttons["warn"] then
                for i , p in pairs(warningbankick) do 
                    RageUI.Button("Warn Player for "..p.name, nil, { RightLabel = "~w~→" }, true, function(Hovered, Active, Selected)
                        if Selected then
                        
                            TriggerServerEvent("lvl:warnPlayer",SelectedPlayer[3],p.name)
                            notify(SelectedPlayer[3])
                            notify("~w~Warned Player for "..p.name)
                        end
                    end, RMenu:Get('adminmenu', 'submenu'))
                 end
            end
...
RageUI.CreateWhile(1.0, true, function()
    if RageUI.Visible(RMenu:Get('adminmenu', 'bansub')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            ...
            if admincfg.buttonsEnabled["ban"][1] and buttons["ban"] then
                RageUI.Button("[Custom Ban Message]", nil, {RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        ...
                        if reason2 then 
                            ...
                            TriggerServerEvent('LVL:BanPlayer', uid, SelectedPlayer[3], reason2, timeForBan)
                        end
                ...
                for i , p in pairs(warningbankick) do 
                    RageUI.Button("Ban Player for "..p.name, nil, { RightLabel = ">>>" }, true, function(Hovered, Active, Selected)
                        if Selected then
                            local uid = GetPlayerServerId(PlayerId())
                            local banTime = KeyboardInput("Hours:", "", 20)
                            TriggerServerEvent('LVL:BanPlayer', uid, SelectedPlayer[3], p.name, tonumber(banTime))
                        end
                    end, RMenu:Get('adminmenu', 'submenu'))
                 end
    ...
    if RageUI.Visible(RMenu:Get('adminmenu', 'teleportmenu')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            if admincfg.buttonsEnabled["TP2"][1] and buttons["TP2"] then
                RageUI.Button("Teleport to Player", nil, {RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        local newSource = GetPlayerServerId(PlayerId())
                        TriggerServerEvent('LVL:TeleportToPlayer', newSource, SelectedPlayer[2])
                        notify('~w~Teleported to player.')
                    end
                end, RMenu:Get('adminmenu', 'teleportmenu'))
            end

            if admincfg.buttonsEnabled["TPLoc"][1] and buttons["TPLoc"] then
                RageUI.Button("Teleport Player To Me", nil, {RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent('LVLAdmin:Bring', SelectedPlayer[3])
                        notify('~w~Teleported player to you.')
                    end
                end, RMenu:Get('adminmenu', 'teleportmenu'))
            end

            if admincfg.buttonsEnabled["TP2ME"][1] and buttons["TP2ME"] then
                RageUI.Button("Teleport Player To Admin Island", nil, {RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent("LVL:Teleport2AdminIsland", SelectedPlayer[2])
                        notify('~w~Teleported player to Admin Island.')
                    end
                end, RMenu:Get('adminmenu', 'teleportmenu'))
            end

            if admincfg.buttonsEnabled["TP2ME"][1] and buttons["TP2ME"] then
                RageUI.Button("Return Player to Previous Location", nil, {RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent("LVL:returnplayer", SelectedPlayer[2])
                        notify('~w~Returned Player.')
                    end
                end, RMenu:Get('adminmenu', 'teleportmenu'))
            end
                ...
                if admincfg.buttonsEnabled["TPLoc"][1] and buttons["TPLoc"] then -- TPLoc
                    RageUI.Button("Teleport Player Legion Bank", nil, {RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)
                        if Selected then
                            TriggerServerEvent("LVL:Teleport", SelectedPlayer[2], vector3(151.61740112305,-1035.05078125,29.339416503906))
                            notify('~w~Teleported player to location.')
                        end
                    end, RMenu:Get('adminmenu', 'teleportmenu'))
                end

                if admincfg.buttonsEnabled["TPLoc"][1] and buttons["TPLoc"] then
                    RageUI.Button("Teleport Player To City License Centre", nil, {RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)
                        if Selected then
                            TriggerServerEvent("LVL:Teleport", SelectedPlayer[2], vector3(-537.10968017578,-217.92503356934,37.64965057373 ))
                            notify('~w~Teleported player to location.')
                        end
                    end, RMenu:Get('adminmenu', 'teleportmenu'))
                end
                ...
                if admincfg.buttonsEnabled["TPLoc"][1] and buttons["TPLoc"] then
                    RageUI.Button("Teleport Player To Sandy License Centre", nil, {RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)
                        if Selected then
                            TriggerServerEvent("LVL:Teleport", SelectedPlayer[2], vector3(1707.1434326172,3775.55078125,34.537727355957))
                            notify('~w~Teleported player to location.')
                        end
                    end, RMenu:Get('adminmenu', 'teleportmenu'))
                end
                ...
                if admincfg.buttonsEnabled["TPLoc"][1] and buttons["TPLoc"] then
                    RageUI.Button("Teleport Player Rebel Diner", nil, {RightLabel = "~w~→"}, true, function(Hovered, Active, Selected)
                        if Selected then
                            TriggerServerEvent("LVL:Teleport", SelectedPlayer[2], vector3(1581.6401367188,6445.6494140625,24.999206542969))
                            notify('~w~Teleported player to location.')
                        end
                    end, RMenu:Get('adminmenu', 'teleportmenu'))
                end
    ...
    if RageUI.Visible(RMenu:Get('adminmenu', 'groups')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            if admincfg.buttonsEnabled["staffGroups"][1] and buttons["staffGroups"] then
                RageUI.Button("Staff Groups", nil, { RightLabel = "~w~→" }, true, function(Hovered, Active, Selected)
                    if (Hovered) then
            ...
            if admincfg.buttonsEnabled["licenseGroups"][1] and buttons["licenseGroups"] then
                RageUI.Button("License Groups", nil, { RightLabel = "~w~→" }, true, function(Hovered, Active, Selected)
                    if (Hovered) then
            ...
            if admincfg.buttonsEnabled["povGroups"][1] and buttons["povGroups"] then
                RageUI.Button("POV Groups", nil, { RightLabel = "~w~→" }, true, function(Hovered, Active, Selected)
                    if (Hovered) then
            ...
            if admincfg.buttonsEnabled["mpdGroups"][1] and buttons["mpdGroups"] then
                RageUI.Button("Police Groups", nil, { RightLabel = "~w~→" }, true, function(Hovered, Active, Selected)
                    if (Hovered) then
            ...
            if admincfg.buttonsEnabled["nhsGroups"][1] and buttons["nhsGroups"] then
                RageUI.Button("NHS Groups", nil, { RightLabel = "~w~→" }, true, function(Hovered, Active, Selected)
                    if (Hovered) then
            ...
            if admincfg.buttonsEnabled["donoGroups"][1] and buttons["donoGroups"] then
                RageUI.Button("Donator Groups", nil, { RightLabel = "~w~→" }, true, function(Hovered, Active, Selected)
                    if (Hovered) then
        ...
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            for k,v in pairs(getStaffGroupsGroupIds) do
                if searchPlayerGroups[k] ~= nil then
                    RageUI.Button("~w~"..v, nil, { RightLabel = "~w~→" }, true, function(Hovered, Active, Selected)
                        if (Selected) then
                    ...
                    RageUI.Button("~r~"..v, nil, { RightLabel = "~w~→" }, true, function(Hovered, Active, Selected)
                        if (Selected) then
...
RageUI.CreateWhile(1.0, true, function()
    if RageUI.Visible(RMenu:Get('adminmenu', 'addgroup')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            ...
            RageUI.Button("Add this group to user", nil, { RightLabel = "~w~→" }, true, function(Hovered, Active, Selected)
                if (Selected) then
                    
                    TriggerServerEvent("LVL:addGroup",SelectedPerm,selectedGroup)
                end
            end, RMenu:Get('adminmenu', 'groups'))
...
RageUI.CreateWhile(1.0, true, function()
    if RageUI.Visible(RMenu:Get('adminmenu', 'removegroup')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            ...
            RageUI.Button("Remove user from group", "", { RightLabel = "~w~→" }, true, function(Hovered, Active, Selected)
                if (Selected) then
                    TriggerServerEvent("LVL:removeGroup",SelectedPerm,selectedGroup)
                end
            end, RMenu:Get('adminmenu', 'groups'))
...
RegisterNetEvent('LVL:SlapPlayer')
AddEventHandler('LVL:SlapPlayer', function()
    SetEntityHealth(PlayerPedId(), 0)
end)

FrozenPlayer = false

RegisterNetEvent('LVL:Freeze')
AddEventHandler('LVL:Freeze', function(isForzen)
...
RegisterNetEvent('LVL:Teleport')
AddEventHandler('LVL:Teleport', function(coords)
    print(coords)
    SetEntityCoords(PlayerPedId(), coords)
end)

RegisterNetEvent('LVL:Teleport2Me2')
AddEventHandler('LVL:Teleport2Me2', function(target2)
    local coords = GetEntityCoords(GetPlayerPed(GetPlayerFromServerId(target2)))
    SetEntityCoords(PlayerPedId(), coords)
end)


RegisterNetEvent("LVL:SendPlayersInfo")
AddEventHandler("LVL:SendPlayersInfo",function(players_table, btns)
...
RegisterNetEvent('LVL:SpectateClient')
AddEventHandler('LVL:SpectateClient', function(target)
...
RegisterNetEvent("LVL:gotgroups")
AddEventHandler("LVL:gotgroups",function(gotGroups)
...
Citizen.CreateThread(function()
    while (true) do
        ...
        if InSpectatorMode then
            ...
            Draw2DText(0.22, 0.90, 'Health: ~w~' .. GetEntityHealth(targetPed) .. " / " .. GetEntityMaxHealth(targetPed), 0.65) 
            Draw2DText(0.22, 0.86, 'Armor: ~w~' .. GetPedArmour(targetPed) .. " / " .. GetPlayerMaxArmour(targetPlayerId), 0.65)
			for i=0, 32, 1 do
				if i ~= PlayerId() then
...
RegisterNetEvent('LVL:Notify')
AddEventHandler('LVL:Notify', function(string)
    notify('~w~' .. string)
end)

RegisterCommand('openadminmenu',function()
    TriggerServerEvent("LVL:GetPlayerData")
end)
...
RegisterNetEvent("LVL:TPCoords")
AddEventHandler("LVL:TPCoords", function(coords)
...
RegisterNetEvent("LVL:EntityWipe")
AddEventHandler("LVL:EntityWipe", function(id)
    Citizen.CreateThread(function() 
...
RegisterNetEvent('LVLAdmin:Spectate')
AddEventHandler('LVLAdmin:Spectate', function(plr,tpcoords)
    local playerPed = PlayerPedId()
    ...
    if not Spectating then
        ...
        if targetPed == playerPed then tLVL.notify('~r~I mean you cannot spectate yourself...') return end
        ...
        tLVL.notify('~w~Spectating Player.')
    else 
        ...
        tLVL.notify('~r~Stopped Spectating Player.')
    end 
end)