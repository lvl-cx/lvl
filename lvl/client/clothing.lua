RMenu.Add('LVLClothing', 'main', RageUI.CreateMenu("", "LVL Clothing Menu",1300, 50, 'cstore', 'cstore'))
...
RageUI.CreateWhile(1.0, true, function()
    ...
    if RageUI.Visible(RMenu:Get('LVLClothing', 'main')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
           RageUI.Button("Change Clothing", nil, {RightLabel = '→'}, true, function(Hovered, Active, Selected) end, RMenu:Get("LVLClothing", "clothingsubmenu"))
           RageUI.Button("Change Gender", nil, {RightLabel = '→'}, true, function(Hovered, Active, Selected) end, RMenu:Get("LVLClothing", "changegendersubmenu"))
           RageUI.Button("Change Ped", nil, {RightLabel = '→'}, true, function(Hovered, Active, Selected) end, RMenu:Get("LVLClothing", "changepedmenu"))
        end)
    end
