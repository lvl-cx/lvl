...
-- [RageUI Menu]
RMenu.Add('CocaineMenu', 'Cocaine Seller', RageUI.CreateMenu("", "~b~LVL Cocaine Seller",1300, 50, "cocaine", "cocaine"))

RageUI.CreateWhile(1.0, true, function()
  if RageUI.Visible(RMenu:Get('CocaineMenu', 'Cocaine Seller')) then
      RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
    
    RageUI.Button("Sell Cocaine" , nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
        if Selected then
