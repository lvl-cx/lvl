...
local lang = {
  ...
  itemtr = {
    informer = {
      title = "Informant",
      description = "{1} €",
      bought = "~b~Position wurde an dein GPS gesendet."
    }
  },
  mission = {
    blip = "Auftrag ({1}) {2}/{3}",
  ...
  aptitude = {
    ...
    earn_exp = "Fähigkeit ~b~{1}/{2} ~b~+{3} ~s~erf.",
    level_down = "Fähigkeit ~b~{1}/{2} ~r~verschlechtert ({3}).",
    level_up = "Fähigkeit ~b~{1}/{2} ~b~verbessert ({3}).",
    display = {
      group = "{1}: ",
