...
local lang = {
  ...
  atm = {
    ...
    withdraw = {
      ...
      withdrawn = "~b~{1}$ ~s~ снято со счета.",
  ...
  phone = {
    ...
    directory = {
      ...
      add = {
        ...
        added = "~b~Запись сохранена."
      },
      sendsms = {
        title = "Отправить SMS",
        prompt = "Введите текст сообщения (максимум {1} символов):",
        sent = "~b~ Отправлено на номер {1}.",
  ...
  itemtr = {
    informer = {
      ...
      description = "{1} $",
      bought = "~b~Позиция отправлена на ваш GPS."
    }
  },
  mission = {
    blip = "Миссия ({1}) {2}/{3}",
  ...
  aptitude = {
    ...
    earn_exp = "Способность ~b~{1}/{2} ~b~+{3} ~s~опыт.",
    level_down = "Способность ~b~{1}/{2} ~r~уровень упал ({3}).",
    level_up = "Способность ~b~{1}/{2} ~b~уровень вырос ({3}).",
    display = {
      group = "{1}: ",
