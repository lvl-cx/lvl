...
local lang = {
  ...
  police = {
    ...
    pc = {
      ...
      trackveh = {
        ...
        tracking = "~g~Слежение активировано.",
        track_failed = "~g~Слежение {1}~s~ ({2}) ~n~~r~ не удалось.",
      ...
      records = {
        ...
        delete = {
          ...
          deleted = "~g~Полицеский записи удалены"
        }
      }
    },
    menu = {
      ...
      seize = {
        ...
        weapons = {
          ...
          seized = "~g~Ваше оружие было изъято."
        },
        items = {
          title = "Изъять нелегал",
          description = "Изъять нелегальные предметы",
          seized = "~g~У вас был изъят нелегал."
        }
      },
      jail = {
        title = "Тюрьма",
        ...
        jailed = "~g~Посажен.",
        unjailed = "~g~Выпущен.",
        notify_jailed = "~g~Вы были посажены в Тюрьму.",
        notify_unjailed = "~g~Вы были выпущены на свободу."
      },
      fine = {
        title = "Штраф",
        description = "Оштрафовать ближайшего игрока.",
        fined = "~g~Оштрафован на ~s~{2} $ за ~g~{1}.",
        notify_fined = "~g~Вы были оштрафованы на ~s~ {2} $ за ~g~{1}.",
        record = "[Штраф] {2} $ за {1}"
      },
      store_weapons = {
  ...
  aptitude = {
    ...
    lose_exp = "Способность ~g~{1}/{2} ~r~-{3} ~s~опыт.",
    earn_exp = "Способность ~g~{1}/{2} ~g~+{3} ~s~опыт.",
    level_down = "Способность ~g~{1}/{2} ~r~уровень упал ({3}).",
    level_up = "Способность ~g~{1}/{2} ~g~уровень вырос ({3}).",
    display = {
      group = "{1}: ",
