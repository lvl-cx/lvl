...
local lang = {
  ...
  inventory = {
    ...
    give = {
      ...
      received = "Vous avez reçu ~b~{1} ~s~{2}.",
    },
    trash = {
      title = "Jeter",
  ...
  atm = {
    ...
    withdraw = {
      ...
      withdrawn = "Vous avez retiré ~b~{1}€ ~s~.",
...
vehicle = {
  ...
  itemtr = {
    informer = {
      ...
      description = "{1} €",
      bought = "~b~Position envoyée au GPS."
    }
  },
  items = {
    dirty_money = {
    ...
    level_up = "Aptitude ~b~{1}/{2} ~b~le level monte ({3}).",
    display = {
    group = "{1}: ",
