...
local lang = {
  ...
  itemtr = {
    informer = {
      ...
      description = "{1} $",
      bought = "~b~Se ha enviado la posición a tu GPS."
    }
  },
  mission = {
    blip = "Trabajo ({1}) {2}/{3}",
  ...
  aptitude = {
    ...
    earn_exp = "Habilidad ~b~{1}/{2} ~b~+{3} ~s~exp.",
    level_down = "Habilidad ~b~{1}/{2} ~r~perdida level ({3}).",
    level_up = "Habilidad ~b~{1}/{2} ~b~ganado level ({3}).",
    display = {
      group = "{1}: ",
