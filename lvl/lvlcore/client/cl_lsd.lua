...
-- [RageUI Menu]
RMenu.Add('LSDMenu', 'LSD Seller', RageUI.CreateMenu("", "LVL LSD Seller",1300, 50, "lsd", "lsd"))

RageUI.CreateWhile(1.0, true, function()
  if RageUI.Visible(RMenu:Get('LSDMenu', 'LSD Seller')) then
      RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
    
    RageUI.Button("Sell LSD" , nil, {RightLabel = "→"}, true, function(Hovered, Active, Selected)
        if Selected then
