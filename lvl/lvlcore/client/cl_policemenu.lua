RMenu.Add('LVLPDMenu', 'main', RageUI.CreateMenu("", "LVL Police Menu", 1300, 50, 'police', 'police'))
    ...
    if RageUI.Visible(RMenu:Get('LVLPDMenu', 'main')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            if IsPedInAnyVehicle(GetPlayerPed(-1), false) == false then
                RageUI.Button("Object Menu" , nil, { RightLabel = '→'}, true, function(Hovered, Active, Selected) end, RMenu:Get('LVLPDMenu', 'objectmenu'))
