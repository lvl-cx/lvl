...
RMenu.Add("CosmeticMenu", "main",  RageUI.CreateMenu("", "~g~LVL Cosmetic Menu", 1300, 50, "cosmetics", "cosmetics"))
        ...
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            for i,v in pairs(cosmetics.cfg) do
                if SelectedCosmetic == v.item then 
                    ...
                    RageUI.Button('List on LVL Market Place', nil, {RightLabel = "~g~→"}, true, function(Hovered, Active, Selected) 

                    end, RMenu:Get("CosmeticMenu", "marketplace"))

                    RageUI.Separator("~g~discord.gg/LVL - #market-place", function() end)
                end
            end
    end)            
end
