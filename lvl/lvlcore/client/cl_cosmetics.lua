...
RMenu.Add("CosmeticMenu", "main",  RageUI.CreateMenu("", "~b~LVL Cosmetic Menu", 1300, 50, "cosmetics", "cosmetics"))
...
RageUI.CreateWhile(1.0, true, function()
    if RageUI.Visible(RMenu:Get("CosmeticMenu", "main")) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            RageUI.Button('Buy Cosmetics', nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected) 
            end, RMenu:Get("CosmeticMenu", "buycosmetics"))

            RageUI.Button('Your Cosmetics', nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected) 
                if Selected then 
...
RageUI.CreateWhile(1.0, true, function()
    if RageUI.Visible(RMenu:Get("CosmeticMenu", "buycosmetics")) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            RageUI.Separator("Cosmetic Shop Day: ~b~1", function() end)
            RageUI.Button('Standard Items', nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected) 
            end, RMenu:Get("CosmeticMenu", "standard"))

            RageUI.Button('Limited Time Items', nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected) 
...
RageUI.CreateWhile(1.0, true, function()
    if RageUI.Visible(RMenu:Get("CosmeticMenu", "limited")) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            RageUI.Separator("Cosmetic shop will reset: ~b~" .. 'Tommorow', function() end)
            for i,v in pairs(cosmetics.limitedshop) do 

                RageUI.Button(v.item, nil, {RightLabel = "~b~£" .. getMoneyStringFormatted(v.price)}, true, function(Hovered, Active, Selected)
                    if Selected then 
...
RageUI.CreateWhile(1.0, true, function()
    if RageUI.Visible(RMenu:Get("CosmeticMenu", "standard")) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            RageUI.Separator("~b~These items will always be in the cosmetic shop", function() end)
        ...
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            for i,v in pairs(cosmetics.shop) do 
                if CosmeticItem == v.item then
                    RageUI.Separator("Cosmetic Name: ~b~" .. v.item, function() end)
                    RageUI.Separator("Cosmetic Price: ~b~£" .. getMoneyStringFormatted(v.price), function() end)
                    RageUI.Separator("~b~Are you sure you want to purchase this cosmetic?", function() end)
                    ...
                    RageUI.Button('Decline', nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected) 
                        if Selected then 
    ...
    if RageUI.Visible(RMenu:Get("CosmeticMenu", "buycosmeticsublimit")) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            for i,v in pairs(cosmetics.limitedshop) do 
                if CosmeticItem == v.item then
                    RageUI.Separator("Cosmetic Name: ~b~" .. v.item, function() end)
                    RageUI.Separator("Cosmetic Price: ~b~£" .. v.price, function() end)
                    RageUI.Separator("~b~Are you sure you want to purchase this cosmetic?", function() end)
        ...
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            for i,v in pairs(cosmetics.cfg) do
                if SelectedCosmetic == v.item then 
                    RageUI.Separator("Cosmetic Name: ~b~" .. v.item, function() end)
                    RageUI.Separator("Cosmetic Price: ~b~£" .. tostring(getMoneyStringFormatted(v.price)), function() end)
                    RageUI.Separator("Cosmetic Type: ~b~" .. v.type, function() end)
                    RageUI.Separator("Cosmetic Refund Price: ~b~£" .. tostring(getMoneyStringFormatted(v.price * 0.25)), function() end)
                    -- [Equip Cosmetic]
                            ...
                            if Selected then 
                                if not VestEquip then
                                    if GetPedArmour(PlayerPedId()) ~= 0 then 
                                        ...
                                        TriggerEvent('LVL:ChangeArmour', v.clothingid, v.index)
                                        TriggerEvent('LVL:ChangeArmour2', v.clothingid, v.index)
                                        VestEquip = true
                                    else
                    ...
                    -- [Other Options]
                    RageUI.Button('Sell Cosmetic to player', nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected) 
                        if Selected then
                    ...
                    RageUI.Button('Refund Cosmetic ~b~[25% Back]', nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected) 
                    end, RMenu:Get("CosmeticMenu", "refundconfirm"))


                    RageUI.Button('List on LVL Market Place', nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected) 

                    end, RMenu:Get("CosmeticMenu", "marketplace"))

                    RageUI.Separator("~b~discord.gg/lvlgta - #market-place", function() end)
                end
            end
    end)            
end
        ...
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            for i,v in pairs(cosmetics.cfg) do 
                if SelectedCosmetic == v.item then
                    ...
                    RageUI.Button('Enter Listing Price - ~b~£' .. listingprice, nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected) 
                        if Selected then 
                    ...
                    RageUI.Button('Enter Custom Message - ~b~' .. listingmessage, nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected) 
                        if Selected then 
                    ...
                    RageUI.Button('Confirm', 'Listing Price: ~b~£' .. listingprice .. '\n~w~Listing Message: ~b~' .. listingmessage .. '\n~w~Item Name: ~b~' .. v.item, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected) 
                        if Selected then 
                            if cooldown <= 0 then 
        ...
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            for i,v in pairs(cosmetics.cfg) do 
                if SelectedCosmetic == v.item then
                    ...
                    RageUI.Separator("Cosmetic Type: ~b~" .. v.type, function() end)
                    RageUI.Separator("Cosmetic Refund Price: ~b~£" .. tostring(getMoneyStringFormatted(v.price * 0.25)), function() end)
                    RageUI.Separator("~b~Are you sure you want to refund this ?", function() end)
...
-- [Functions/ Events]
RegisterNetEvent('LVL:ResetCosmetics')
AddEventHandler('LVL:ResetCosmetics', function(type2) -- [Remove All of Ped Cosmetics]
    if type2 == 'Vest' then 
        SetPedComponentVariation(PlayerPedId(), 9, 0, 0, 0) 
...
RegisterNetEvent('LVL:ReturnCosmetic')
AddEventHandler('LVL:ReturnCosmetic', function(rdata)
    data = rdata
end)
