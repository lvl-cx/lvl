...
--RegisterNetEvent("IFN:PoliceClockedOn")
--AddEventHandler("IFN:PoliceClockedOn", function(MetPD)
--    onduty = MetPD
--end)
...
newSubMenus = {
    ...
    --     functionName = "IFN:ComingSoon"
    -- }, 
    ['vehmenu:lockpick'] = {
        title = "Lockpick Vehicle",
        icon = "#general-keys-give",
        functionName = "IFN:LockPick2"
    },
    ['general:exitmenu'] = {
        title = "Exit Menu",
    ...
    ['police:cpr'] = {
        ...
        functionName = 'IFNClient:ReviveCPR'
    },
    ...
    ['vehmenupd:clampveh'] = {
        title = "Clamp Vehicle",
        icon = "#car-side",
        functionName = "IFN:ClampVehicle"
    },  
    ['vehmenupd:unclampveh'] = {
        title = "Unclamp Vehicle",
        icon = "#car-side",
        functionName = "IFN:UnClampVehicles"
    },  
    ['general:exitmenu'] = {
        title = "Exit Menu",
        icon = "#animation-hurry",
    ...
    ['general:emotes'] = {
        title = "Store Weapons",
        icon = "#general-emotes",
        functionName = "IFN:Storeweapons"
    },    
    ['general:askid'] = {
        title = "Ask For ID",
        icon = "#police-vehicle-plate",
        functionName = "IFN:AskID"
    },
    ['general:searchnearest'] = {
        title = "Search Player",
        icon = "#cuffs-check-inventory",
        functionName = "IFN:SearchNearest"
    },
...
--[[     ['judge-raid:checkowner'] = {
    ...
    ['police:jail'] = {
        title = "Jail Near",
        icon = "#cuffs-cuff",
        functionName = 'IFN:Jail'
    }, 
    ['police:unjail'] = {
        title = "Unjail Player",
        icon = "#cuffs-uncuff",
        functionName = "IFN:Unjail"
    }, 

    ['police:fine'] = {
        title = "Fine Nearest",
        icon = "#animation-money",
        functionName = 'IFN:Fine'
    }, 
    ['police:seize'] = {
        title = "Seize Weapons",
        icon = "#police-action-remove-weapons",
        functionName = 'IFN:SeizeWeapons'
    }, 
    ['police:seizeitems'] = {
        title = "Seize Items",
        icon = "#police-action-remove-weapons",
        functionName = 'IFN:SeizeItems'
    }, 
    ['cuffs:softcuff'] = {
        title = "Soft Cuff",
        icon = "#cuffs-cuff",
...
--[[     ['cuffs:remmask'] = {
    ...
    ['police:escort'] = {
        title = "Drag Player",
        icon = "#general-escort",
        functionName = 'IFN:policeDrag'
    },
    ['police:putinvehicle'] = {
        title = "Put In Vehicle",
        icon = "#general-put-in-veh",
        functionName = "IFN:putinveh"
    },
    ['police:unseatnearest'] = {
        title = "Unseat Player",
        icon = "#general-unseat-nearest",
        functionName = "IFN:takeoutveh"
    },
    ['police:cuff'] = {
        title = "Cuff",
        icon = "#cuffs-cuff",
