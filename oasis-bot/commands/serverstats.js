...
exports.runcmd = (fivemexports, client, message, params) => {
    ...
    let totalBank = 0
    let totalChips = 0
    fivemexports.ghmattimysql.execute("SELECT * FROM `oasis_user_vehicles`", [], (cars) => {
        fivemexports.ghmattimysql.execute("SELECT * FROM `oasis_user_vehicles` WHERE locked = 1", [], (lockedcars) => {
            fivemexports.ghmattimysql.execute("SELECT * FROM `oasis_user_data`", [], (userdata) => {
                fivemexports.ghmattimysql.execute("SELECT * FROM oasis_warnings", [], (warnings) => {
                    fivemexports.ghmattimysql.execute("SELECT * FROM oasis_user_moneys", [], (money) => {
                        fivemexports.ghmattimysql.execute("SELECT * FROM oasis_casino_chips", [], (chips) => {
                            fivemexports.ghmattimysql.execute("SELECT * FROM `oasis_users`", [], (users) => {
