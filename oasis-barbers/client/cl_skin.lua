...
RegisterNUICallback('updateSkin', function(data)
	...
	if v == true then
		...
		TriggerServerEvent("OASIS:saveFaceData",faceSaveData)
	end
end)
...
RegisterNetEvent("OASIS:setHairstyle")
AddEventHandler("OASIS:setHairstyle",function(hairstyle)
    if hairstyle then
...
AddEventHandler("OASIS:openBarbershop",function()
