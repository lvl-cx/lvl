RMenu.Add('ATMClothing', 'main', RageUI.CreateMenu("", "~g~ATM Clothing Menu",1300, 50, 'cstore', 'cstore'))
RMenu.Add('ATMClothing', 'clothingsubmenu',  RageUI.CreateSubMenu(RMenu:Get("ATMClothing", "main")))
RMenu.Add('ATMClothing', 'changegendersubmenu',  RageUI.CreateSubMenu(RMenu:Get("ATMClothing", "main")))
RMenu.Add('ATMClothing', 'changepedmenu',  RageUI.CreateSubMenu(RMenu:Get("ATMClothing", "main")))
...
RageUI.CreateWhile(1.0, true, function()
    ...
    if RageUI.Visible(RMenu:Get('ATMClothing', 'main')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
           RageUI.Button("Change Clothing", nil, {RightLabel = '~g~→'}, true, function(Hovered, Active, Selected) end, RMenu:Get("ATMClothing", "clothingsubmenu"))
           RageUI.Button("Change Gender", nil, {RightLabel = '~g~→'}, true, function(Hovered, Active, Selected) end, RMenu:Get("ATMClothing", "changegendersubmenu"))
           RageUI.Button("Change Ped", nil, {RightLabel = '~g~→'}, true, function(Hovered, Active, Selected) end, RMenu:Get("ATMClothing", "changepedmenu"))
        end)
    end
    if RageUI.Visible(RMenu:Get('ATMClothing', 'changegendersubmenu')) then 
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            ...
            end,RMenu:Get("ATMClothing", "changegendersubmenu"))
    ...
    if RageUI.Visible(RMenu:Get('ATMClothing', 'changepedmenu')) then 
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
    ...
    if RageUI.Visible(RMenu:Get('ATMClothing', 'clothingsubmenu')) then
...
RegisterNetEvent('ATM:ClothingPerms')
AddEventHandler('ATM:ClothingPerms', function(bool)
    print(bool)
    clothingPerm = bool
end)
...
Citizen.CreateThread(function()
    while true do 
        ...
        if not MenuOpen and inMarker then 
            MenuOpen = true
            TriggerServerEvent('ATM:HasFounder')
            RageUI.Visible(RMenu:Get('ATMClothing', 'main'), true) 
        ...
        if not inMarker and MenuOpen then
            ...
            PlaySound(-1,"Hit","RESPAWN_SOUNDSET",0,0,1)
            RageUI.Visible(RMenu:Get('ATMClothing', 'clothingsubmenu'), false)
            RageUI.Visible(RMenu:Get('ATMClothing', 'changegendersubmenu'), false)  
            RageUI.Visible(RMenu:Get('ATMClothing', 'main'), false)
            MenuOpen = false
        end
    end
end)
