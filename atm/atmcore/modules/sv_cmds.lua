...
RegisterCommand('ooc', function(source, args, rawCommand)
...
}}), { ["Content-Type"] = "application/json" })  if ATM.hasGroup(user_id, 'founder') then
    TriggerClientEvent('chat:addMessage', -1, {
  ...
  elseif ATM.hasGroup(user_id, 'commanager') then
    TriggerClientEvent('chat:addMessage', -1, {
    ...
    ---
  elseif ATM.hasGroup(user_id, 'trialstaff') then
    TriggerClientEvent('chat:addMessage', -1, {
  ...
  elseif ATM.hasGroup(user_id, 'moderator') then
    TriggerClientEvent('chat:addMessage', -1, {
  ...
  elseif ATM.hasGroup(user_id, 'srmoderator') then
    TriggerClientEvent('chat:addMessage', -1, {
  ...
  elseif ATM.hasGroup(user_id, 'administrator') then
    TriggerClientEvent('chat:addMessage', -1, {
    ...
    ---
  elseif ATM.hasGroup(user_id, 'staffmanager') then
    TriggerClientEvent('chat:addMessage', -1, {
  ...
  elseif ATM.hasGroup(user_id, 'headadmin') then
    TriggerClientEvent('chat:addMessage', -1, {
  ...
  elseif ATM.hasGroup(user_id, 'senioradmin') then
    TriggerClientEvent('chat:addMessage', -1, {
      template = '<div style="padding: 0.5vw; margin: 0.4vw; background-color: rgba(0, 0, 0, 0.6); border-radius: 8px;"><i class="fas fa-globe"></i> OOC | ^3Head Administrator^7 {0}: {1}</div>',
      args = { playerName, msg }
    })
...
RegisterCommand('clear', function(source, args, rawCommand)
  ...
  if ATM.hasPermission(user_id, 'admin.ban') then
    ...
    ATMclient.notify(source,{"~r~You do not have permission to use this command."})
  end
end, false)

RegisterServerEvent("ATM:ClockingOff")
AddEventHandler("ATM:ClockingOff", function()
	print("Player has clocked off")
	TriggerClientEvent("ATM:ClockingOff123", source)
end)

RegisterCommand("clockingoff", function()
	TriggerEvent("ATM:ClockingOff")
end)
