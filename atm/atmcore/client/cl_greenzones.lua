...
Citizen.CreateThread(function()
	while true do
		if showEnterGreenzone and greenzoneTimer > 0 then
			TriggerEvent("ATMNotify:Success",nil,"You have entered a Greenzone!","top-right",nil,true)
		end
		if showExitGreenzone and greenzoneTimer > 0 then
			TriggerEvent("ATMNotify:Negative",nil,"You have entered a exited a Greenzone!","top-right",nil,true)
		end
		Wait(0)
	end
end)
