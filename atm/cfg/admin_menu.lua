...
cfg.Buttons = {
    ...
    TriggerServerEvent('ATMAdmin:Ban', self, hours, reason)
    end, "player.ban"},
    ["Kick"] = {function(self)
    ...
    if (GetOnscreenKeyboardResult()) then
        ...
        if result then 
            result = result
            TriggerServerEvent('ATMAdmin:Kick', self, result, false)
        end
    end
    end, "player.kick"},
    ["No Warning Kick"] = {function(self)
        ...
        if (GetOnscreenKeyboardResult()) then
            ...
            if result then 
                result = result
                TriggerServerEvent('ATMAdmin:Kick', self, result, true)
            end
        end
    end, "player.kick"},
    ["Revive"] = {function(self)
        TriggerServerEvent('ATMAdmin:Revive', self)
    end, "player.revive"},
    ["Slap"] = {function(self)
        TriggerServerEvent('ATMAdmin:SlapPlayer', self)
    end, "player.slap"},
    ["Spectate"] = {function(self)
        TriggerServerEvent('ATMAdmin:SpectatePlr', self)
    end, "player.spectate"},
    ...
    ["Add Car"] = {function(self)
        ...
        if (GetOnscreenKeyboardResult()) then
            local result = GetOnscreenKeyboardResult()
            if result then 
                TriggerServerEvent('ATMAdmin:AddCar', self, result)
            end
        end
    end, "player.addcar"},
    ["TP To Player"] = {function(self)
        TriggerServerEvent('ATMAdmin:TPTo', self)
    end, "player.tpto"},
    ["Bring Player"] = {function(self)
        TriggerServerEvent('ATMAdmin:Bring', self)
    end, "player.tpbring"},
    ["Add Group"] = {function(self)
        ...
        if (GetOnscreenKeyboardResult()) then
            local result = GetOnscreenKeyboardResult()
            if result then 
                TriggerServerEvent('ATMAdmin:AddGroup', self, result)
            end
        end
    ...
    ["Warn Player"] = {function(self)
        ...
        if userWarningMessage then
            TriggerServerEvent("atm:warnPlayer",self,userWarningMessage)
        else
            tATM.notify('Please enter a warning message!')
        end
    end, "player.kick"},
...
cfg.MiscButtons = {
    ["Entity Cleanup"] = {function(self)
        TriggerServerEvent('ATMAdmin:PropCleanup')
    ...
    ["Remove Warning"] = {function(self)
        ...
        if (GetOnscreenKeyboardResult()) then
            local result = GetOnscreenKeyboardResult()
            if result then 
                TriggerServerEvent('ATM:RemoveWarning', result)
            end
        end
    end, "admin.removewarning", "Removes a warning"},
    ["Entity Cleanup Gun"] = {function(self)
        TriggerServerEvent('ATMAdmin:EntityCleanupGun')
    ...
    ["Shutdown Server"] = {function(self)
        TriggerServerEvent('ATMAdmin:ServerShutdown')
