...
Config.Languages = {
  ['en'] = {
        ...
        ['newsetemote'] = "~w~ is now your bound emote, press ~b~CapsLock~w~ to use it.",
        ...
        ['doyouwanna'] = "~y~Y~w~ to accept, ~r~L~w~ to refuse (~b~",
        ['refuseemote'] = "Emote refused.",
        ['makenearby'] = "makes the nearby player play",
        ['camera'] = "Press ~y~b~w~ to use camera flash.",
        ['makeitrain'] = "Press ~y~b~w~ to make it rain.",
        ['pee'] = "Hold ~y~b~w~ to pee.",
        ['spraychamp'] = "Hold ~y~b~w~ to spray champagne",
        ['bound'] = "Bound ",
        ['to'] = "to",
  ...
  ['fr'] = {
        ...
        ['newsetemote'] = "~w~ est maintenant votre emote liée, appuyez sur ~b~CapsLock~w~ pour l'utiliser.",
        ...
        ['doyouwanna'] = "~y~Y~w~ accepter, ~r~L~w~ refuser (~b~",
        ['refuseemote'] = "Emote refusée.",
        ['makenearby'] = "fait jouer le joueur à proximité",
        ['camera'] = "Presse ~y~b~w~ utiliser le flash de l'appareil.",
        ['makeitrain'] = "Presse ~y~b~w~ jeter de l'argent.",
        ['pee'] = "Tenir ~y~b~w~ faire pipi.",
        ['spraychamp'] = "Tenir ~y~b~w~ vaporiser du champagne.",
        ['bound'] = "Liée ",
        ['to'] = "à",
  ...
  ['de'] = {
        ...
        ['newsetemote'] = "~w~ ist jetzt dein gebundenes Emote, drücke ~b~CapsLock~w~, um es zu verwenden.",
        ...
        ['sentrequestto'] = "Gesendete Anfrage an ~b~",
        ['nobodyclose'] = "Niemand ist nah genug dran.",
        ['doyouwanna'] = "~y~Y~w~ zu akzeptieren, ~r~L~w~ zu verweigern (~b~",
        ['refuseemote'] = "Emote abgelehnt.",
        ['makenearby'] = "Lässt den Spieler in der Nähe spielen",
        ['camera'] = "Drücken ~y~b~w~ Kamerablitz verwenden.",
        ['makeitrain'] = "Drücken ~y~b~w~ Geld werfen.",
        ['pee'] = "Halt ~y~b~w~ urinieren.",
        ['spraychamp'] = "Halt ~y~b~w~ champagner sprühen",
        ['bound'] = "Gebunden ",
        ['to'] = "zu",
  ...
  ['sv'] = {
        ...
        ['newsetemote'] = "~w~ är nu din favorit emote, tryck ~b~CapsLock~w~ för att använda den.",
        ...
        ['sentrequestto'] = "Skickad förfrågan till ~b~",
        ['nobodyclose'] = "Ingen ~r~nära~w~ tillräckligt.",
        ['doyouwanna'] = "~y~Y~w~ för att acceptera, ~r~L~w~ för att vägra (~b~",
        ['refuseemote'] = "Emote vägrades.",
        ['makenearby'] = "andra personen spelar",
        ['camera'] = "Tryck ~y~b~w~ för att använda blixt.",
        ['makeitrain'] = "Tryck ~y~b~w~ för att kasta pengar.",
        ['pee'] = "Håll ~y~b~w~ att kissa.",
        ['spraychamp'] = "Håll ~y~b~w~ för att spraya champagne.",
        ['bound'] = "Bunde ",
        ['to'] = "till",
  ...
  ['es'] = {
        ...
        ['newsetemote'] = "~w~ es ahora tu animacion favorita, presiona ~b~[CapsLock]~w~ para usarla.",
        ...
        ['doyouwanna'] = "~y~Y~w~ para aceptar, ~r~L~w~ para rechazar (~b~",
        ['refuseemote'] = "Animacion rechazada.",
        ['makenearby'] = "hacer que el jugador cercano juegue",
        ['camera'] = "Presione ~y~b~w~ para usar el flash de la camara.",
        ['makeitrain'] = "Presiona ~y~b~w~ para hacer llover.",
        ['pee'] = "Mantiene ~y~b~w~ para mear.",
        ['spraychamp'] = "Mantiene ~y~b~w~ rociar champán.",
        ['bound'] = "Unida ",
        ['to'] = "a",
