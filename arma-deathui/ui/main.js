	...
	var e = {
			...
			118: (e, t, n) => {
				...
				n.r(t), n.d(t, {
					...
					if (t >= 0) {
						...
						n.items ? e.showNestedMenu(n) : e.onClick && (e.onClick(n), e.closeOnClick && (e.close(), fetch("http://lunar/disablenuifocus", {
							method: "POST",
							body: JSON.stringify({
								nuifocus: !1
							})
					...
					var e = this;
					e.parentItems.length > 0 ? e.returnToParentMenu() : (e.close(), fetch("http://lunar/disablenuifocus", {
						method: "POST",
						body: JSON.stringify({
							nuifocus: !1
						})
			...
			22: (e, t, n) => {
				...
				class o extends a.Component {
					...
					countdownEnded() {
						fetch("https://lunarui/countdownEnded", {
							method: "POST",
							body: ""
						...
						if (1 == e.data.openMenu)
							if ("ped" == e.data.type) {
								...
								t = 1 == e.data.police ? new o.default({
									...
									menuItems: u,
									onClick: function(t) {
										fetch("http://arma-deathui/radialClick", {
											method: "POST",
											body: JSON.stringify({
												itemid: t.id,
					...
					render() {
						return s.jsx(s.Fragment, {
							children: s.jsx("div", Object.assign({
								className: "lunar-spawn"
							}, {
								children: s.jsxs("div", Object.assign({
									className: "lunar-locations"
								}, {
			...
			527: (e, t) => {
				...
				Object.defineProperty(t, "__esModule", {
					...
					switch (n.type) {
						case "APP_TOGGLE":
							//return console.log("toggling: " + n.app), Object.assign(Object.assign({}, e), {
						...
						case "RESPAWN_BUTTON_CLICK":
							return fetch("https://arma-deathui/respawnButtonClicked", {
								method: "POST",
								body: JSON.stringify({
