RMenu.Add('gangmenu', 'main', RageUI.CreateMenu("", "LVL Gang Menu", 1300, 50, "gang", "gang"))
...
RageUI.CreateWhile(1.0, RMenu:Get('gangmenu', 'main'), nil, function()
    RageUI.IsVisible(RMenu:Get('gangmenu', 'main'), true, false, true, function()
        ...
        RageUI.ButtonWithStyle("Turf Info", nil, { RightLabel = "→" }, true, function(Hovered, Active, Selected)
            if Selected then
            end
        ...
        RageUI.Separator("Gang Info", function() end)
    ...
    RageUI.IsVisible(RMenu:Get("gangmenu", "funds"),true, false,true,function()
        RMenu:Get("gangmenu", "funds"):SetSubtitle("LVL Funds Tab")
    ...
    RageUI.IsVisible(RMenu:Get("gangmenu", "invite"),true, false,true,function()
        ...
        RageUI.ButtonWithStyle("Members Perm ID - " .. MembersPermInvIs, nil, {RightLabel = "→"}, true, function(Hovered, Active, Selected)
            if Selected then
    ...
    RageUI.IsVisible(RMenu:Get("gangmenu", "turf"),true, false,true,function()
        RMenu:Get("gangmenu", "turf"):SetSubtitle("Current Turf Info")
        RageUI.Separator("LSD Turf: " .. lsdturf .. '%', function() end)
        RageUI.Separator("Heroin Turf: " .. herointurf .. '%', function() end)
        RageUI.Separator("Cocaine Turf: " .. cocaineturf .. '%', function() end)
        RageUI.Separator("Weed Turf: " .. weedturf .. '%', function() end)
        RageUI.Separator("Global Weapon Trader Turf: " .. globalturf .. '%', function() end)
    end)
...
RMenu.Add('gangmenu', 'notingang', RageUI.CreateMenu("", "LVL Gang Menu", 1300, 50, "gang", "gang"))
            ...
            if Selected then
                ...
                if (GetOnscreenKeyboardResult()) then
                    ...
                    if result then
                        ...
                        notify('You have set name as: [' .. CreatedGangName .. ']')
                    end
                end
