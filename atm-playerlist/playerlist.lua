...
local header = [[<tr class= "titles"><th class="id">ID</th><th></th><th class="name">Name</th><th></th><th class="title">Job</th><th class="time">Online</th></tr>]]
...
local footer = [[<tr class="titles"><th colspan="3" class="title">Online:<br/>%i / %i</th><th></th><th colspan="1" class="title">Uptime:<br/>%s</th><th colspan="2" class="title">Ping:<br />%s</th></tr>]] -- online uptime connections
...
--            print("sending open call")
			TriggerServerEvent("gd_playerlist:askOpen", last_playerlist_identifier)
		elseif IsControlJustReleased(1, 83) then --Stop holding
            plist = false
--            print("closing call")
			ClosePlayerList()
		end
