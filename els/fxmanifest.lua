...
files {
	...
	"data/dlc_oasisheist_sounds.dat54.rel",
	"dlc_oasisheist/glass_break.awc",
...
data_file "AUDIO_WAVEPACK"  "dlc_oasisheist"
data_file "AUDIO_SOUNDDATA" "data/dlc_oasisheist_sounds.dat"
