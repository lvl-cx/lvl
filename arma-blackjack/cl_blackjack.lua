...
function goToBlackjackSeat(blackjackSeatID)
    ...
    --print("[ARMA Casino] start sit at blackjack seat") 
    ...
    --print("[ARMA Casino] blackjack anims loaded") 
    ...
    --print("[ARMA Casino] fVars passed")
    ...
    --print("[ARMA Casino] walking to seat, x: " .. tostring(walkToVector.x) .. " y: " .. tostring(walkToVector.y) .. " z: " .. tostring(walkToVector.z))
    ...
    --print("[ARMA Casino] Blackjack sit at table net scene starting")
    --print("[ARMA Casino] creating Scene at, x: " .. tostring(goToVector.x) .. " y: " .. tostring(goToVector.y) .. " z: " .. tostring(goToVector.z))
    ...
    --print("[ARMA Casino] Blackjack sit at table net scene started")
...
function betChipsForNextHand(chipsAmount,chipsProp,something,chairID,someBool,zOffset)
    ...
    while not HasModelLoaded(chipsProp) do  
        Wait(0)
        --print("[ARMA Casino] Stuck requesting model: " .. tostring(chipsProp))
        RequestModel(chipsProp)
    end
    vVar8 =  vector3(0.0, 0.0, getTableHeading(blackjack_func_368(chairID)))
    local tablePosX,tablePosY,tablePosZ = getTableCoords(blackjack_func_368(chairID))
...
Citizen.CreateThread(function()
    blip = AddBlipForCoord(924.46765136719,45.492050170898,81.106338500977)
...
Citizen.CreateThread(function()
    blip = AddBlipForCoord(1115.3065185547,219.49897766113,-49.435123443604)
    ...
    SetBlipAsShortRange(blip, true)
    BeginTextCommandSetBlipName("STRING")
    AddTextComponentString('Buy Chips')
    EndTextCommandSetBlipName(blip)
end)

Citizen.CreateThread(function()
    blip = AddBlipForCoord(1147.6140136719,265.73080444336,-51.8408203125)
...
Citizen.CreateThread(function()
    blip = AddBlipForCoord(1111.5718994141,228.80969238281,-49.635227203369)
    ...
    SetBlipAsShortRange(blip, true)
    BeginTextCommandSetBlipName("STRING")
    AddTextComponentString('Casino Weel')
    EndTextCommandSetBlipName(blip)
end)
