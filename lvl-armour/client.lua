...
RegisterNetEvent('LVL:ChangeArmour')
AddEventHandler('LVL:ChangeArmour', function(id, indexz)
  clothingID = id
  index = indexz
end)

function LVLbm.getHealth()
...
function LVLbm.setHealth(armour,vest)
